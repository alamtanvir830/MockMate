...
const CLASSROOM_NAV_ITEMS: NavItem[] = [
  ...
  { href: '/exams', label: 'My Practice Exams', icon: ICON_HISTORY },
    ...
    >
      ...
      <div className={cn(
        ...
        <button
          ...
          className="flex h-7 w-7 shrink-0 items-center justify-center rounded-md text-slate-400 hover:bg-slate-100 hover:text-slate-600 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-400"
        >
      ...
      {collapsed ? (
        <div className="flex flex-col items-center px-2 pt-2 pb-1">
          <NavTooltip label="Switch product">
            <Link
              href="/choose-study-path"
              aria-label="Switch product"
              className="flex h-10 w-10 items-center justify-center rounded-lg text-slate-400 hover:bg-slate-100 hover:text-slate-600 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-400"
            >
              <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} className="h-5 w-5 shrink-0" aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" />
              </svg>
            </Link>
          </NavTooltip>
        ...
        <div className="px-3 pt-2 pb-1">
          <Link
            href="/choose-study-path"
            className="flex items-center gap-2 rounded-lg px-3 py-1.5 text-xs font-medium text-slate-500 hover:bg-slate-100 hover:text-slate-700 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-400"
          >
      ...
      >
        {navItems.map(({ href, label, icon, premium, exact, inactiveClass, inactiveIconClass }) => {
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    premium
                      ...
                      : effectiveActive
                        ? 'bg-brand-50 text-brand-600 focus-visible:ring-brand-400'
                        : inactiveIconClass
                          ? `${inactiveIconClass} hover:bg-slate-100 focus-visible:ring-brand-400`
                          : 'text-slate-400 hover:bg-slate-100 hover:text-slate-700 focus-visible:ring-brand-400',
                  )}
                >
                  {icon}
                </Link>
          ...
          return (
            ...
            >
              <span className={cn('shrink-0', effectiveActive ? 'text-brand-600' : inactiveIconClass ?? 'text-slate-400')}>
                {icon}
              </span>
              {label}
            </Link>
        ...
        {collapsed ? (
            ...
            <NavTooltip label="Sign out">
              <form action={logout}>
                <button
                  type="submit"
                  aria-label="Sign out"
                  className="flex h-10 w-10 items-center justify-center rounded-lg text-slate-400 hover:bg-slate-100 hover:text-slate-700 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-400"
                >
                  {SIGN_OUT_ICON}
                </button>
              </form>
          ...
          <>
            ...
            <form action={logout}>
              <button
                type="submit"
                className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-400"
              >
