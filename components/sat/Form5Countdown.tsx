...
// Displays live HH:MM:SS countdowns for Form 5 free access windows.
...
export function Form5CountdownBanner({ expiresAt }: BannerProps) {
      ...
      <div className="flex flex-col sm:flex-row sm:items-start gap-3">
        <div className="flex-1 min-w-0">
          <p className="font-semibold text-brand-900 text-sm">
            SAT Form 5 is free for 48 hours
          </p>
          <p className="text-xs text-brand-700 mt-0.5">
            Start Form 5 before the promotional window ends.
          </p>
...
export function Form5DashboardBanner({ expiresAt, actionHref, actionLabel }: DashboardBannerProps) {
  const secs = useCountdown(expiresAt)
      ...
      <div className="flex flex-col sm:flex-row sm:items-start gap-4 flex-wrap">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[12px] text-brand-700 leading-relaxed">
            Take SAT Practice Form 5 free before the timer expires.
          </p>
...
// ── Compact inline badge for the Form 5 card ─────────────────────────────────
...
export function Form5CountdownBadge({ expiresAt, className }: BadgeProps) {
  const secs = useCountdown(expiresAt)
