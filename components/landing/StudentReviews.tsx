const reviews = [
  {
    quote:
      'The math section felt challenging and very close to SAT-style questions.',
    name: 'J. N.',
    label: 'SAT Form 1',
  },
  {
    quote:
      'Both Reading & Writing modules were clear, accurate, and easy to use.',
    name: 'M. D.',
    label: 'SAT Form 1',
  },
  {
    quote:
      'The second module felt much harder and adapted based on my first results.',
    name: 'A. P.',
    label: 'SAT Form 1',
  },
  {
    quote:
      'Accurate to my test experience — matched the pacing and time pressure well.',
    name: 'P. S.',
    label: 'SAT Form 1',
  },
  {
    quote:
      'The questions looked very SAT-style and gave me realistic, rigorous practice.',
    name: 'A. S.',
    label: 'SAT Form 1',
  },
]
  ...
  return (
    <section className="py-14 bg-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Desktop: 3-column grid (first 3). Mobile: horizontal scroll all 5. */}
        ...
        <div className="md:hidden -mx-4 px-4 overflow-x-auto scroll-smooth snap-x snap-mandatory flex gap-4 pb-4">
          ...
          {/* Trailing spacer so last card snaps clear of edge */}
          ...
          {reviews.map((r, i) => (
            <div
              ...
              className={`h-1.5 rounded-full transition-all ${
                i === 0 ? 'w-4 bg-emerald-600' : 'w-1.5 bg-slate-200'
              }`}
            />
          ))}
        </div>
...
function ReviewCard({
  ...
  return (
    <div className="flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-5 shadow-sm hover:shadow-md transition-shadow h-full">
      ...
      <div>
        <svg
          className="h-5 w-5 text-emerald-400 mb-2"
          fill="currentColor"
          viewBox="0 0 24 24"
          aria-hidden
        >
