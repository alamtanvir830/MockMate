...
export const LANDING_USER_COUNT_LABEL = '1,340+'
    ...
    <>
      ...
      <style>{`
        ...
        @keyframes sp-glow-in {
          from { box-shadow: 0 2px 8px rgba(68,165,240,0.06), 0 1px 3px rgba(0,0,0,0.04); }
          to   { box-shadow: 0 2px 16px rgba(68,165,240,0.14), 0 1px 6px rgba(0,0,0,0.06); }
        }
        ...
        .sp-card:hover {
          ...
          box-shadow: 0 6px 24px rgba(68,165,240,0.18), 0 2px 8px rgba(0,0,0,0.07) !important;
        }
      ...
      <div
        ...
        style={{
          ...
          boxShadow: '0 2px 8px rgba(68,165,240,0.06), 0 1px 3px rgba(0,0,0,0.04)',
        }}
      >
