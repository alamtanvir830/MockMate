/**
 * Validates SAT Form 4 Math Modules.
 * Run: npx tsx scripts/validate-sat-form4-math.ts
 */
...
const m1  = validateModule(f4MathModule1Questions,       'Math Module 1 (routing)', 22)
const m2e = validateModule(f4MathModule2EasyQuestions,   'Math Module 2 Easy',      22)
const m2h = validateModule(f4MathModule2HardQuestions,   'Math Module 2 Hard',      22)
