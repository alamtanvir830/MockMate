/**
 * Validates SAT Form 1 Math Modules.
 * Run: npx tsx scripts/validate-sat-form1-math.ts
 */
...
const m1  = validateModule(mathModule1Questions,       'Math Module 1 (routing)', 22)
const m2e = validateModule(mathModule2EasyQuestions,   'Math Module 2 Easy',      22)
const m2h = validateModule(mathModule2HardQuestions,   'Math Module 2 Hard',      22)
