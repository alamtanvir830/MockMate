/**
 * Validates SAT Form 2 Math Modules.
 * Run: npx tsx scripts/validate-sat-form2-math.ts
 */
...
const m1  = validateModule(f2MathModule1Questions,      'Form 2 Math Module 1',      22)
const m2e = validateModule(f2MathModule2EasyQuestions,  'Form 2 Math Module 2 Easy', 22)
const m2h = validateModule(f2MathModule2HardQuestions,  'Form 2 Math Module 2 Hard', 22)
