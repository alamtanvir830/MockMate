-- Consolidated migration: creates sat_premium_purchases and processed_stripe_events if they do not exist.

-- ── processed_stripe_events ───────────────────────────────────────────────────
-- Source: supabase/migrations/20260719_stripe_events_idempotency.sql
--
...
create policy if not exists "service_role_only" on processed_stripe_events
  as restrictive
...
-- ── sat_premium_purchases ─────────────────────────────────────────────────────
-- Source: supabase/migrations/20260724_sat_premium_one_time_plans.sql
--
