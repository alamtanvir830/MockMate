...
export const rwModule2EasyQuestions: RWQuestion[] = [
...

  {
    ...
    choices: [
      ...
      { label: 'B', text: 'transmit' },
      { label: 'C', text: 'request' },
      { label: 'D', text: 'store' },
    ],
    correctAnswer: 'B',
    explanation: `Choice B is correct. The scout bee uses its dance to pass navigational information to other bees. "Transmit" means to send or pass information from one party to another, which is exactly what the bee is doing.`,
    wrongAnswerExplanations: {
      A: `Choice A is incorrect. "Disguise" means to conceal, but the purpose of the dance is to reveal, not hide, information.`,
...

  {
    ...
    correctAnswer: 'B',
    explanation: `Choice B is correct. In this context, "sustain controlled flight" means to keep controlled flight going continuously. "Maintain" captures this meaning of keeping something ongoing or in operation.`,
    wrongAnswerExplanations: {
      ...
      C: `Choice C is incorrect. "Endure" typically implies suffering through hardship, which does not fit the technical context of maintaining flight.`,
...

  {
    ...
    choices: [
      { label: 'A', text: 'automobile' },
      { label: 'B', text: 'means' },
      { label: 'C', text: 'obstacle' },
      { label: 'D', text: 'reward' },
    ],
    correctAnswer: 'B',
    explanation: `Choice B is correct. Butler saw science fiction as a "vehicle" for exploring social questions, meaning she used the genre as a method or means of inquiry. "Means" accurately captures this figurative usage.`,
    wrongAnswerExplanations: {
      A: `Choice A is incorrect. The passage is using "vehicle" figuratively; there is no literal automobile in context.`,
...

  {
    ...
    choices: [
      ...
      { label: 'B', text: 'ordinariness' },
      { label: 'C', text: 'complexity' },
      { label: 'D', text: 'secrecy' },
    ],
    correctAnswer: 'B',
    explanation: `Choice B is correct. Arendt's phrase "banality of evil" refers to the idea that evil can be mundane rather than spectacular — the product of thoughtless compliance by ordinary people. "Ordinariness" best captures "banality," which the passage defines through its description of Eichmann as unremarkable.`,
    wrongAnswerExplanations: {
      ...
      C: `Choice C is incorrect. "Complexity" suggests difficulty or intricacy, which contradicts the passage's emphasis on thoughtlessness and mundaneness.`,
...

  {
    ...
    choices: [
      ...
      { label: 'B', text: 'describe a self-reinforcing cycle in which thaw amplifies the warming that caused it' },
    ...
    correctAnswer: 'B',
    explanation: `Choice B is correct. The passage explains the feedback loop immediately after naming it: warming → thaw → greenhouse gas release → more warming. The phrase introduces the concept of a self-amplifying cycle, and choice B accurately describes what the passage defines.`,
    wrongAnswerExplanations: {
      A: `Choice A is incorrect. The passage does not discuss reversing permafrost thaw; the feedback loop is presented as a danger, not a solution.`,
...

  {
    ...
    choices: [
      ...
      { label: 'B', text: 'describe how one scientific theory replaced another and what that transition involved' },
      { label: 'C', text: 'explain the experimental methods Pasteur and Koch used in their research' },
      { label: 'D', text: 'warn readers about the continued dangers of miasma in urban environments' },
    ],
    correctAnswer: 'B',
    explanation: `Choice B is correct. The passage traces a historical transition from miasma theory to germ theory, notes why the old theory seemed plausible, and concludes that the shift required both new evidence and new conceptual frameworks. This is a description of one theory replacing another.`,
    wrongAnswerExplanations: {
      ...
      D: `Choice D is incorrect. The passage presents miasma theory as a historical belief that was replaced, not as a current threat.`,
    },
  },
...
Text 2: While social media literacy programs sound appealing in principle, researchers have found that brief classroom interventions produce only modest improvements in students' ability to detect false information, and that these gains often fade quickly after the instruction ends. More structural solutions — including platform regulation and algorithmic transparency requirements — may be necessary to address misinformation at scale.`,
...

  {
    ...
    choices: [
      { label: 'A', text: 'Literate societies tend to have more extensive archives than oral societies.' },
      { label: 'B', text: 'A researcher comparing multiple oral performances of a traditional epic across different communities finds that core narrative elements and key phrases remain consistent.' },
    ...
    correctAnswer: 'B',
    explanation: `Choice B is correct. If multiple oral performances of the same text in different communities preserve the same core elements and phrases, this directly supports the claim that skilled oral performers maintain textual integrity across time and place.`,
    wrongAnswerExplanations: {
      A: `Choice A is incorrect. Comparing archive sizes between literate and oral societies says nothing about the accuracy of oral transmission.`,
...

  {
    ...
    choices: [
      ...
      { label: 'B', text: '"Middle school students who exercised at least 30 minutes daily showed GPA improvements averaging 0.4 points compared to sedentary peers."' },
      { label: 'C', text: '"Physical education classes in middle schools have been reduced in many districts due to budget constraints."' },
      { label: 'D', text: '"Adult workers who exercise regularly report reduced absenteeism and higher job satisfaction."' },
    ],
    correctAnswer: 'B',
    explanation: `Choice B is correct. This quotation directly measures the relationship between daily exercise and GPA in middle school students, which is precisely the claim the student wants to support.`,
    wrongAnswerExplanations: {
      A: `Choice A is incorrect. Social belonging and school spirit are not measures of academic performance.`,
      C: `Choice C is incorrect. This describes a policy trend, not evidence of a relationship between exercise and academic outcomes.`,
...
2023 | 32.4`,
    ...
    choices: [
      ...
      { label: 'B', text: 'Solar capacity added annually in the U.S. increased nearly sevenfold between 2013 and 2023.' },
      { label: 'C', text: 'Solar energy capacity increased between 2017 and 2019.' },
      { label: 'D', text: 'The United States added more solar capacity in 2023 than in 2021.' },
    ],
    correctAnswer: 'B',
    explanation: `Choice B is correct. The table shows growth from 4.8 GW in 2013 to 32.4 GW in 2023 — nearly a sevenfold increase over the decade. This single statistic most powerfully conveys the dramatic growth the student wants to demonstrate.`,
    wrongAnswerExplanations: {
      ...
      D: `Choice D is incorrect. A two-year comparison between 2021 and 2023 does not capture the full scope of decade-long growth.`,
    },
  },

  {
    ...
    choices: [
      ...
      { label: 'B', text: '"A facial recognition system trained on a dataset that underrepresented darker-skinned faces had an error rate five times higher for darker-skinned women than for lighter-skinned men."' },
      { label: 'C', text: '"AI-assisted hiring tools have been adopted by 67% of Fortune 500 companies since 2018."' },
      { label: 'D', text: '"Researchers have proposed several mathematical frameworks for defining and measuring algorithmic fairness."' },
    ],
    correctAnswer: 'B',
    explanation: `Choice B is correct. This quotation shows a specific AI system exhibiting differential accuracy based on race and gender — a direct demonstration that AI can perpetuate bias when trained on unrepresentative data.`,
    wrongAnswerExplanations: {
      ...
      D: `Choice D is incorrect. Proposing frameworks for measuring fairness is a response to bias, not direct evidence of bias in AI systems.`,
    },
  },
...

  {
    ...
    choices: [
      { label: 'A', text: 'occur primarily in urban areas where cassowaries have lost their fear of humans' },
      { label: 'B', text: 'are most likely to happen when humans threaten the birds or their offspring' },
    ...
    correctAnswer: 'B',
    explanation: `Choice B is correct. The passage states cassowaries "attack humans only when cornered, provoked, or defending their young." This directly supports the inference that attacks are most likely when humans pose a threat to the birds or their offspring.`,
    wrongAnswerExplanations: {
      A: `Choice A is incorrect. The passage says cassowaries live in rainforests and are shy; there is no mention of urban areas.`,
...

  {
    ...
    choices: [
      ...
      { label: 'B', text: 'she believed reviewers would evaluate her work more fairly without knowing her gender' },
      { label: 'C', text: 'women were legally prohibited from publishing novels in the nineteenth century' },
      { label: 'D', text: 'male authors received higher payment from publishers than female authors did' },
    ],
    correctAnswer: 'B',
    explanation: `Choice B is correct. The passage explains that women's writing was "routinely dismissed" and that Eliot's decision "proved effective" because reviewers praised the work without gendered expectations. This strongly implies she used a male name to avoid the bias that would have come with being identified as a woman writer.`,
    wrongAnswerExplanations: {
      ...
      D: `Choice D is incorrect. The passage does not mention payment differences; the issue is critical reception, not financial compensation.`,
    },
  },
...
• mRNA vaccine technology, used in COVID-19 vaccines developed in 2020, represented a new approach that could be adapted quickly to emerging viruses.`,
    ...
    choices: [
      ...
      { label: 'B', text: 'Vaccines have evolved from Jenner\'s eighteenth-century smallpox preparation to twenty-first-century mRNA technology, achieving major reductions in disease along the way.' },
      { label: 'C', text: 'The measles vaccine reduced U.S. cases from approximately 500,000 to under 100 annually within two decades.' },
      { label: 'D', text: 'mRNA vaccines represent the most innovative development in vaccine history.' },
    ],
    correctAnswer: 'B',
    explanation: `Choice B is correct. The student's goal is to introduce historical development over time. Only choice B spans the full historical range described in the notes (from 1796 to 2020) and captures the arc of progress, making it the most effective introductory sentence.`,
    wrongAnswerExplanations: {
      ...
      D: `Choice D is incorrect. It makes an evaluative claim about mRNA vaccines without introducing the broader sweep of vaccine history.`,
    },
  },
...
• Some workers who moved to lower-cost areas during the pandemic reported increased purchasing power despite similar salaries.`,
...

  {
    ...
    correctAnswer: 'B',
    explanation: `Choice B is correct. The passage describes one navigational method (magnetic field) and then adds another (stars and sun). "In addition" signals the addition of a supplementary point, which is the relationship between the two sentences.`,
    wrongAnswerExplanations: {
      ...
      D: `Choice D is incorrect. "As a result" signals causation, implying that magnetic field detection causes star navigation, which is illogical.`,
    },
  },
