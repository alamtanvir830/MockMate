...
//
// After the global Form 7 window expires on 2026-08-18T00:05:00Z, every NEW
...
export const ROLLING_PROMO_CONFIG = {
  ...
  durationHours: 36,
  promoStartsAt: '2026-08-18T00:05:00Z', // Must match FORM7_WINDOW_ENDS_AT in form7-access.ts
} as const
