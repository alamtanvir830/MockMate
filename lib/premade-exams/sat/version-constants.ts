...
export const FORM_MINIMUM_VERSION: Partial<Record<number, SATContentVersion>> = {
  7: 3, // Form 7 rebuilt as V3 — all V2 in-progress attempts must restart
}
