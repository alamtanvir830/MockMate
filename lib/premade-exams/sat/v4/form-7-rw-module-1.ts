...
export const f7RwModule1QuestionsV4: RWQuestion[] = [
  // ─── GROUP 1: Craft and Structure ─────────────────────────────────────────────

  // ─── q01 | easy | Craft and Structure — Words in Context | correctAnswer: B ───
  // IMPROVED from V3: new stimulus with subtler vocabulary signal; answer not a
  // direct echo of a word already in the passage.
  {
    id: 'sat-f7-v4-rw-m1-q01',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
    domain: 'Craft and Structure',
    skill: 'Words in Context',
    difficulty: 'easy',
    stimulus:
      'The marine biologist spent months at sea collecting water samples and recording water temperatures at precisely measured depths. Her research notebook contained hundreds of entries, each noting the time, coordinates, and conditions — nothing was left to chance or approximation. Colleagues described her fieldwork as _______ , noting that she applied the same exacting protocols to every dive regardless of weather or fatigue.',
    question: 'Which choice completes the text with the most logical and precise word or phrase?',
    choices: [
      { label: 'A', text: 'adventurous' },
      { label: 'B', text: 'rigorous' },
      { label: 'C', text: 'spontaneous' },
      { label: 'D', text: 'celebrated' },
    ],
    correctAnswer: 'B',
    explanation:
      '"Rigorous" means thorough and demanding, proceeding with strict adherence to standards. The passage describes precise measurements, detailed notebooks, and consistent protocols applied in all conditions — all markers of rigorous practice.',
    wrongAnswerExplanations: {
      A: '"Adventurous" describes a willingness to take risks or try new experiences. The passage emphasizes consistency and precision, not novelty or risk-seeking.',
      C: '"Spontaneous" means unplanned or impulsive, which contradicts the description of standardized, repeatable protocols applied regardless of circumstances.',
      D: '"Celebrated" means widely admired or famous. While the biologist may be respected, the passage focuses on her methodology, not her reputation or public recognition.',
    },
  },

  // ─── q02 | easy | Craft and Structure — Words in Context | correctAnswer: A ───
  {
    id: 'sat-f7-v4-rw-m1-q02',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
    domain: 'Craft and Structure',
    skill: 'Words in Context',
  ...
  // ─── q03 | medium | Craft and Structure — Words in Context | correctAnswer: C ───
  {
    id: 'sat-f7-v4-rw-m1-q03',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
    domain: 'Craft and Structure',
    skill: 'Words in Context',
    ...
    wrongAnswerExplanations: {
      A: '"Skepticism" means doubt or disbelief; while researchers might verify information, the passage focuses on the time-sensitive nature of the interviews, not on questioning the elders\'s credibility.',
  ...
  // ─── q04 | medium | Craft and Structure — Words in Context | correctAnswer: D ───
  {
    id: 'sat-f7-v4-rw-m1-q04',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
    domain: 'Craft and Structure',
    skill: 'Words in Context',
  ...
  // ─── q05 | medium | Craft and Structure — Text Structure and Purpose | correctAnswer: C ───
  // IMPROVED from V3: rewritten stimulus so the purpose is expressed through
  // structural moves, not through a single signaling phrase that gives away the answer.
  {
    id: 'sat-f7-v4-rw-m1-q05',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
    domain: 'Craft and Structure',
    ...
    difficulty: 'medium',
    stimulus:
      'To a casual observer, a sand dune seems to be little more than an inert mound of grains held in place by gravity. This impression, however, is misleading. Wind continuously lifts individual grains from the dune\'s windward face, carries them forward, and deposits them on the steep downwind slope called the slip face. As grain after grain accumulates on the slip face, the entire dune shifts forward — sometimes advancing tens of meters in a single year. In certain desert regions, this movement has carried dunes across farmland and roads and into the outskirts of villages.',
    ...
    correctAnswer: 'C',
    explanation:
      'The passage opens by contrasting the appearance of dunes as inert mounds with the reality that they migrate, then explains the mechanism — grain-by-grain movement via the slip face — that drives this migration. The purpose is to correct a common misconception about dune behavior, not primarily to warn readers or catalog geological processes.',
    wrongAnswerExplanations: {
      A: 'While the passage mentions dunes reaching farmland and villages, this is one illustrative detail at the end, not the primary purpose of the text.',
  ...
  // ─── q07 | hard | Craft and Structure — Words in Context | correctAnswer: A ───
  {
    id: 'sat-f7-v4-rw-m1-q07',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
    domain: 'Craft and Structure',
    skill: 'Words in Context',
  ...
  // ─── q08 | hard | Craft and Structure — Text Structure and Purpose | correctAnswer: D ───
  // IMPROVED from V3: distractors sharpened so that B is plausible but distinguishable.
  {
    id: 'sat-f7-v4-rw-m1-q08',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
    domain: 'Craft and Structure',
    skill: 'Text Structure and Purpose',
    ...
    choices: [
      ...
      { label: 'B', text: 'To suggest that medieval cartographers were aware their maps were geographically inaccurate but prioritized spiritual meaning over accuracy' },
    ...
    wrongAnswerExplanations: {
      ...
      B: 'The passage does not claim that medieval cartographers knew their maps were geographically inaccurate. The passage argues the maps had a different purpose, not that their makers acknowledged geographic shortcomings.',
  ...
  // ─── q09 | hard | Craft and Structure — Cross-Text Connections | correctAnswer: B ───
  {
    id: 'sat-f7-v4-rw-m1-q09',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
    domain: 'Craft and Structure',
  ...
  // ─── q11 | medium | Information and Ideas — Central Ideas and Details | correctAnswer: C ───
  {
    id: 'sat-f7-v4-rw-m1-q11',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
    domain: 'Information and Ideas',
    skill: 'Central Ideas and Details',
  ...
  // ─── q16 | hard | Information and Ideas — Inferences | correctAnswer: C ───
  {
    id: 'sat-f7-v4-rw-m1-q16',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
    domain: 'Information and Ideas',
    skill: 'Inferences',
  ...
  // ─── q17 | easy | Standard English Conventions — Boundaries | correctAnswer: B ───
  {
    id: 'sat-f7-v4-rw-m1-q17',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
  ...
  // ─── q18 | medium | Standard English Conventions — Boundaries | correctAnswer: D ───
  {
    id: 'sat-f7-v4-rw-m1-q18',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
    domain: 'Standard English Conventions',
    skill: 'Boundaries',
  ...
  // ─── q19 | medium | Standard English Conventions — Form, Structure, and Sense | correctAnswer: B ───
  {
    id: 'sat-f7-v4-rw-m1-q19',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
    domain: 'Standard English Conventions',
  ...
  // ─── q20 | hard | Standard English Conventions — Boundaries | correctAnswer: C ───
  {
    id: 'sat-f7-v4-rw-m1-q20',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
    domain: 'Standard English Conventions',
    skill: 'Boundaries',
  ...
  // ─── q23 | medium | Expression of Ideas — Transitions | correctAnswer: B ───
  {
    id: 'sat-f7-v4-rw-m1-q23',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
    domain: 'Expression of Ideas',
    skill: 'Transitions',
  ...
  // ─── q24 | medium | Expression of Ideas — Transitions | correctAnswer: B ───
  {
    id: 'sat-f7-v4-rw-m1-q24',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
    domain: 'Expression of Ideas',
    skill: 'Transitions',
  ...
  // ─── q26 | medium | Expression of Ideas — Rhetorical Synthesis | correctAnswer: A ───
  {
    id: 'sat-f7-v4-rw-m1-q26',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
    domain: 'Expression of Ideas',
  ...
  // ─── q27 | hard | Expression of Ideas — Rhetorical Synthesis | correctAnswer: D ───
  {
    id: 'sat-f7-v4-rw-m1-q27',
    section: 'reading-writing',
    moduleId: 'f7v4-rw-module-1',
    domain: 'Expression of Ideas',
    skill: 'Rhetorical Synthesis',
