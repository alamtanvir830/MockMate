...
export const mathModule1Questions: MathQuestion[] = [
...

  {
    ...
    difficulty: 'easy',
    type: 'multiple_choice',
    question: 'A bag contains only red marbles and blue marbles. There are 5 red marbles and 3 blue marbles. If x represents the total number of marbles in the bag, which equation is correct?',
    choices: [
      { label: 'A', text: 'x = 5 + 3' },
      { label: 'B', text: 'x = 5 − 3' },
      { label: 'C', text: 'x = 5 × 3' },
    ...
    correctAnswer: 'A',
    explanation: 'The total number of marbles equals the sum of red and blue marbles: x = 5 + 3 = 8.',
    wrongAnswerExplanations: {
      B: 'Subtracting gives the difference between red and blue marbles, not the total.',
      C: 'Multiplying gives the product, which has no meaning here.',
      D: 'Dividing gives a ratio, not a total count.',
    },
  },

  {
    ...
    difficulty: 'easy',
    type: 'multiple_choice',
    question: 'Which of the following values of x satisfies the inequality x + 4 < 10?',
    choices: [
      { label: 'A', text: '6' },
      { label: 'B', text: '7' },
      { label: 'C', text: '5' },
    ...
    correctAnswer: 'C',
    explanation: 'Solving the inequality: x + 4 < 10 → x < 6. Of the choices, only x = 5 is less than 6.',
    wrongAnswerExplanations: {
      A: 'x = 6 gives 6 + 4 = 10, which is not less than 10.',
      B: 'x = 7 gives 7 + 4 = 11 > 10, which does not satisfy the inequality.',
      D: 'x = 8 gives 8 + 4 = 12 > 10, which does not satisfy the inequality.',
    },
  },
