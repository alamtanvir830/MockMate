...
export const mathModule1Questions: MathQuestion[] = [
...

  {
    ...
    correctAnswer: 'A',
    explanation: 'The total bill is 120 + 0.40w < 220 (where w is the full shipment weight, with the per-pound rate applying to all w pounds beyond the flat fee structure). Solving: 0.40w < 100 → w < 250. However, the per-pound charge only applies to weight over 200 pounds, so the charge for the excess is 0.40(w − 200). The inequality becomes: 120 + 0.40(w − 200) < 220 → 120 + 0.40w − 80 < 220 → 0.40w + 40 < 220 → 0.40w < 180 → w < 450.',
    wrongAnswerExplanations: {
...

  {
    ...
    correctAnswer: 'B',
    explanation: 'Substitute x = 3 into x + y = 10: 3 + y = 10 → y = 7.',
    wrongAnswerExplanations: {
      A: '3 is the value of x, not y.',
      C: '10 is the sum x + y, not the value of y alone.',
      D: '13 = 10 + 3 adds the total and x instead of subtracting.',
    },
  },
