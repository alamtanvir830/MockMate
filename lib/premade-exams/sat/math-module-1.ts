...
export const mathModule1Questions: MathQuestion[] = [
...

  {
    ...
    wrongAnswerExplanations: {
      A: '−4 is the y-value when x = −3, not at x = 0.',
...

  {
    ...
    choices: [
      ...
      { label: 'C', text: 'Strong positive linear association' },
    ...
    wrongAnswerExplanations: {
      ...
      D: 'The points follow a roughly straight-line pattern, not a curved one.',
    },
  },
