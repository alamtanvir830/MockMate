...
export const rwModule1Questions: RWQuestion[] = [
...

  {
    ...
    choices: [
      { label: 'A', text: 'fantastical and unrealizable' },
      { label: 'B', text: 'imaginative and creative' },
      { label: 'C', text: 'experimental and provisional' },
      { label: 'D', text: 'complex and interdisciplinary' },
    ],
    correctAnswer: 'A',
    explanation: `Choice A is correct. Geertz characterized the pursuit of lawlike generalizations about human behavior as "chimerical," meaning he considered it an impossible fantasy — something appealing in concept but unachievable in reality. "Fantastical and unrealizable" captures this dismissive sense accurately.`,
    wrongAnswerExplanations: {
      B: `Choice B is incorrect. While the word derives from the mythological Chimera (a fantastical creature), "chimerical" in academic usage means illusory or impossible, not creatively imaginative.`,
...
Text 2: Literary critics working in the tradition of sociolinguistics have since validated Hurston's intuitions, demonstrating through empirical research that African American Vernacular English (AAVE) exhibits consistent grammatical rules, complex aspectual distinctions, and a rich oral tradition that standard written English cannot fully represent. They argue that dismissing AAVE as "incorrect" reflects social prejudice, not linguistic analysis.`,
...

  {
    ...
    choices: [
      ...
      { label: 'B', text: 'REM sleep is more prevalent in infants than in adults.' },
      { label: 'C', text: 'The hippocampus is more active during slow-wave sleep than during waking hours.' },
      { label: 'D', text: 'Some individuals who lack REM sleep due to certain medications show normal long-term recall.' },
    ],
    correctAnswer: 'D',
    explanation: `Choice D is correct. The passage claims that disrupting REM sleep impairs recall, implying REM is necessary for consolidation. Finding that individuals without REM sleep can still consolidate memories normally would directly contradict this claim.`,
    wrongAnswerExplanations: {
      ...
      B: `Choice B is incorrect. Information about the prevalence of REM sleep across age groups says nothing about its function in memory consolidation.`,
    },
  },
