...
export const f3RwModule1Questions: RWQuestion[] = [
  ...
  },
  {
    ...
    wrongAnswerExplanations: {
      ...
      C: '"Temporary" relates to duration, but the passage focuses on distribution of harm, not its length.',
  ...
  // ── Text Structure and Purpose (4) ────────────────────────────────────────
  {
    ...
    choices: [
      ...
      { label: 'B', text: 'To explain how the waggle dance allows honeybees to share precise information about food location' },
      { label: 'C', text: 'To compare honeybee navigation with the navigation methods used by migratory birds' },
    ...
    wrongAnswerExplanations: {
      ...
      C: 'Migratory birds are not mentioned; the passage does not make comparisons across species.',
  ...
  },
  {
    ...
    choices: [
      ...
      { label: 'B', text: 'The division between Hurston\'s identity as an anthropologist and her identity as a creative writer' },
      { label: 'C', text: 'The methodological difference between Boas\'s anthropology and Hurston\'s fieldwork approach' },
      { label: 'D', text: 'The gap between the critical reception of Hurston\'s work during her lifetime and after her death' },
    ],
    correctAnswer: 'B',
    ...
    wrongAnswerExplanations: {
      ...
      D: 'The passage does not discuss Hurston\'s reception during versus after her lifetime.',
    },
  },
  ...
  // ── Cross-Text Connections (2) ────────────────────────────────────────────
  {
    ...
    choices: [
      ...
      { label: 'B', text: 'Whether the anomalous rotation of galaxies is caused by dark matter or by a modification of gravitational laws' },
      { label: 'C', text: 'Whether dark matter particles have been detected in laboratory experiments' },
    ...
    wrongAnswerExplanations: {
      ...
      C: 'Neither text discusses laboratory detection of dark matter particles specifically.',
  ...
  // ── Central Ideas and Details (3) ─────────────────────────────────────────
  {
    ...
    choices: [
      ...
      { label: 'B', text: 'The gut microbiome is an active community of microorganisms with wide-ranging effects on human health' },
      { label: 'C', text: 'Bacteria in the gut produce every vitamin the human body requires' },
      { label: 'D', text: 'Anxiety disorders are primarily caused by imbalances in the gut microbiome' },
    ],
    correctAnswer: 'B',
    ...
    wrongAnswerExplanations: {
      ...
      D: 'The passage mentions a link between microbiome disruption and anxiety but does not claim the microbiome is the primary cause of anxiety disorders.',
    },
  },
  {
    id: 'sat-f3-rw-m1-q12',
  ...
  // ── Command of Evidence (4) ───────────────────────────────────────────────
  {
    ...
    choices: [
      ...
      { label: 'B', text: 'The stress reduction associated with green space was consistent across all income brackets in the study' },
      { label: 'C', text: 'Residents who exercised regularly reported lower stress than those who did not, regardless of green space use' },
    ...
    wrongAnswerExplanations: {
      ...
      C: 'Regular exercise as an alternative explanation would undermine rather than support the green space hypothesis.',
  ...
  // ── Inferences (2) ────────────────────────────────────────────────────────
  {
    ...
    choices: [
      ...
      { label: 'B', text: 'A person who has never used a genetic genealogy service may still be identifiable through a relative\'s DNA submission' },
      { label: 'C', text: 'Privacy advocates oppose all forensic uses of DNA evidence in criminal investigations' },
      { label: 'D', text: 'Genetic genealogy databases are less accurate than traditional forensic DNA testing methods' },
    ],
    correctAnswer: 'B',
    ...
    wrongAnswerExplanations: {
      ...
      D: 'Accuracy is never compared between genetic genealogy and traditional forensic methods.',
    },
  },
  {
    id: 'sat-f3-rw-m1-q19',
    ...
    choices: [
      ...
      { label: 'B', text: 'The long-term affordability outcome near rail stations depends partly on regulatory decisions about development' },
      { label: 'C', text: 'Property prices near rail stations never exceed prices in more central neighborhoods' },
      { label: 'D', text: 'High-speed rail links consistently reduce overall regional housing costs' },
    ],
    correctAnswer: 'B',
    ...
    wrongAnswerExplanations: {
      ...
      D: 'The passage describes regional effects as variable, not as consistently reducing costs.',
    },
  },
  ...
  },
  {
    ...
    wrongAnswerExplanations: {
      ...
      C: 'A semicolon joins two independent clauses of roughly equal weight; here, the second clause functions as an explanation of the first, making a colon more appropriate.',
  ...
  },
  {
    ...
    wrongAnswerExplanations: {
      ...
      D: 'Starting a new sentence with "Furthermore" is grammatically acceptable but unnecessarily separates two closely related ideas; the semicolon construction is the preferred standard form.',
    },
  },
  ...
  // ── Rhetorical Synthesis (1) ──────────────────────────────────────────────
  {
    ...
    choices: [
      { label: 'A', text: 'Insufficient sleep impairs working memory and reduces standardized test scores, while later school start times — which allow more sleep — have been linked to higher attendance and fewer disciplinary problems.' },
      ...
      { label: 'D', text: 'Sleep deprivation reduces scores by 12 points, impairs working memory, and slows reaction times, making it the primary cause of academic underperformance in high schools.' },
    ],
    correctAnswer: 'A',
    ...
    wrongAnswerExplanations: {
      ...
      D: 'This choice focuses only on cognitive and test impacts while asserting sleep is "the primary cause" of underperformance, an overstatement not in the notes.',
    },
  },
