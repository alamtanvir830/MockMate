...
export const rwModule1QuestionsV2: RWQuestion[] = [
...

  {
    ...
    choices: [
      { label: 'A', text: 'technically flawed' },
      { label: 'B', text: 'devoid of warmth or interest' },
      { label: 'C', text: 'excessively long' },
      { label: 'D', text: 'factually inaccurate' },
    ],
    correctAnswer: 'B',
    ...
    wrongAnswerExplanations: {
      A: `Choice A is incorrect. The critics do not accuse the philosopher of making errors; their complaint is about the affective quality of the prose, not its logical soundness.`,
      C: `Choice C is incorrect. Nothing in the passage suggests the prose is too long; the criticism concerns its lack of engagement, not its length.`,
      D: `Choice D is incorrect. The passage does not question the accuracy of her claims; the defenders even say making the prose accessible would make it "less honest," implying accuracy is not the issue.`,
    },
  },
...

  {
    ...
    choices: [
      { label: 'A', text: '"The printing press required substantial capital investment, limiting its use to wealthy patrons and state actors who could afford to maintain a press."' },
      ...
      { label: 'C', text: '"Literacy rates in seventeenth-century England varied considerably by region, with rural populations largely unable to access printed materials."' },
    ...
    correctAnswer: 'B',
    explanation: `Choice B is correct. The historian claims printed broadsides enabled national dissent through simultaneous, geographically dispersed circulation of identical messages. The quotation in B directly supports this by showing that identical grievances appeared across multiple cities within days — evidence of simultaneous, coordinated distribution.`,
    wrongAnswerExplanations: {
      A: `Choice A is incorrect. This quotation emphasizes the barriers to press ownership, which would complicate rather than support the claim about widespread dissent.`,
      C: `Choice C is incorrect. Noting that rural populations lacked access would undermine the claim about broad national reach, not support it.`,
      D: `Choice D is incorrect. Evidence that texts varied between print runs directly contradicts the historian's claim that identical messages circulated simultaneously.`,
    },
  },
...

  {
    ...
    correctAnswer: 'B',
    explanation: `Choice B is correct. "Nevertheless" signals that the second sentence is surprising given what the first sentence established. Despite the dramatic expansion of renewables described in the first sentence, fossil fuels have barely declined — an unexpected outcome that "nevertheless" frames as a concession to the initially hopeful picture.`,
    wrongAnswerExplanations: {
      A: `Choice A is incorrect. "Similarly" signals that the second idea parallels the first, but a modest decline in fossil fuels is not parallel to dramatic renewable expansion — it is an unexpected contrast.`,
      C: `Choice C is incorrect. "As a result" signals causation, implying the modest fossil fuel decline is a consequence of renewable expansion, but the passage explains the opposite: growth in demand has absorbed the new renewable capacity.`,
      D: `Choice D is incorrect. "Furthermore" adds a point in the same direction, but the second sentence shifts to a surprising counterpoint, not an additional example of the same trend.`,
    },
  },
