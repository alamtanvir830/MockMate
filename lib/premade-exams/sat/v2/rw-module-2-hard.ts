...
export const rwModule2HardQuestionsV2: RWQuestion[] = [
...

  {
    ...
    skill: 'Boundaries',
    difficulty: 'hard',
    stimulus: `For decades, the prevailing theory held that mammoths went extinct primarily due to climate change at the end of the last ice age _______ recent genetic analyses of preserved mammoth remains suggest that hunting by early human populations played an equally significant role in the collapse of their populations.`,
    question: `Which choice completes the text so that it conforms to the conventions of Standard English?`,
    choices: [
    ...
    correctAnswer: 'A',
    explanation: `Choice A is correct. Both the clause before the blank and the clause beginning with "recent genetic analyses" are independent clauses. The word "however" is a conjunctive adverb, not a coordinating conjunction; conjunctive adverbs cannot be preceded by only a comma when joining two independent clauses. A semicolon before "however" correctly separates the two independent clauses, and a comma follows "however" to set it off from the rest of the second clause.`,
    wrongAnswerExplanations: {
      B: `Choice B is incorrect. Using only a comma before the conjunctive adverb "however" creates a comma splice — a grammatical error in which two independent clauses are joined with only a comma. Conjunctive adverbs require a semicolon (or period) before them when they join independent clauses.`,
      C: `Choice C is incorrect. Omitting punctuation before "however" creates a run-on sentence; two independent clauses cannot be fused together without appropriate punctuation.`,
      D: `Choice D is incorrect. A colon is used to introduce a list, a definition, or an elaboration of what precedes it. It cannot be used before "however," which signals contrast rather than elaboration, and the clause that follows is an independent clause offering a competing claim, not a restatement.`,
    },
  },
