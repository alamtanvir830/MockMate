...
export const f5RwModule1QuestionsV2: RWQuestion[] = [
...

  {
    ...
    choices: [
      ...
      { label: 'C', text: 'Financial firms that adopted the telegraph earlier than their competitors reported higher profits during the 1850s and 1860s.' },
      { label: 'D', text: 'The cost of sending a telegraph message declined steadily between 1850 and 1880 as networks expanded.' },
    ],
    correctAnswer: 'B',
    explanation: 'The historian\'s claim is that the telegraph changed the character of information itself — making it briefer and more declarative. Choice B directly supports this by showing a documented shift in newspaper content from long analytical pieces to short, context-stripped reports, which is evidence of the structural change in how information was conveyed.',
    wrongAnswerExplanations: {
      A: 'Transmission speed addresses how fast information traveled, not how its character or content changed — it supports only the "accelerating" view the historian is arguing against.',
      C: 'Financial profits may reflect competitive advantages from faster communication, but say nothing about whether the nature of the transmitted information changed.',
      D: 'Declining costs explain adoption patterns but do not address how the content or style of information was transformed by telegraph use.',
    },
  },
...

  {
    ...
    correctAnswer: 'C',
    explanation: '"Nevertheless" introduces a concessive contrast: the system achieved its intended benefit (reduced commute times), but there were unintended drawbacks (noise and cut-through traffic) that exist alongside that success. "Nevertheless" correctly signals that the second sentence presents an adverse consequence that qualifies the positive outcome of the first.',
    wrongAnswerExplanations: {
      A: '"As a result" implies the noise and cut-through traffic are a direct logical consequence of reduced commute times, but the second sentence describes a downside that exists despite the success, not because of it as a logical step.',
      B: '"For instance" introduces a specific example of the previous claim; the second sentence does not illustrate the commute-time reduction but instead describes a countervailing problem.',
      D: '"In other words" signals a restatement or clarification; the second sentence introduces new and contrasting information, not a rephrasing of what the first sentence said.',
    },
  },
