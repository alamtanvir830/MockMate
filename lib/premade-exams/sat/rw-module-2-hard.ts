...
export const rwModule2HardQuestions: RWQuestion[] = [
...

  {
    ...
    choices: [
      ...
      { label: 'B', text: 'deliberate concealment' },
      { label: 'C', text: 'formal adoption' },
      { label: 'D', text: 'gradual buildup' },
    ],
    correctAnswer: 'D',
    explanation: `Choice D is correct. The passage describes how regulatory capture develops through gradual processes — personnel movement, informational gaps, and the slow development of norms. "Accretion" means the gradual accumulation of something layer by layer, which fits the implied incremental nature of norm development within regulatory culture.`,
    wrongAnswerExplanations: {
      ...
      B: `Choice B is incorrect. "Deliberate concealment" implies intentional hiding, but "accretion" describes accumulation, not deception.`,
    },
  },
...
Text 2: The philosopher Monroe Beardsley countered that the distinction between literary form and content is not as absolute as formalists like Brooks suggest. While a poem's formal properties undeniably shape its effect, it remains possible to identify propositional content — claims that are asserted or implied — that survives translation into different wordings and can be evaluated as true or false, insightful or banal.`,
...

  {
    ...
    choices: [
      ...
      { label: 'B', text: 'why hydrogen is the most common element in the universe' },
      { label: 'C', text: 'the importance of mentorship in developing scientific talent' },
      { label: 'D', text: 'the institutional obstacles that prevented women scientists from receiving appropriate credit for their work' },
    ],
    correctAnswer: 'D',
    explanation: `Choice D is correct. The passage describes how Payne-Gaposchkin was pressured to disavow her correct finding, which was then published by her supervisor who received the credit. The final sentence explicitly frames this as "emblematic of systemic barriers faced by women in science" — making gender-based institutional obstacles the central lesson.`,
    wrongAnswerExplanations: {
      ...
      B: `Choice B is incorrect. Hydrogen's abundance is part of the discovery described, not the lesson the passage draws from the episode.`,
    },
  },
...
Election 5 | 18 | 51`,
...

  {
    ...
    wrongAnswerExplanations: {
      ...
      B: `Choice B is incorrect. Ostrom showed that successful management occurred without state control, which is precisely what contradicts this claim.`,
    },
  },
