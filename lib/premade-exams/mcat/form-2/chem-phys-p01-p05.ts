    ...
    questions: [
      {
        ...
        wrongAnswerExplanations: {
          ...
          D: '2.0 mM corresponds to v = 60 μmol/min, which is four-fifths of Vmax. This is the apparent Km only for the inhibited enzyme at α ≈ 4, not for the uninhibited enzyme.',
        },
    ...
    questions: [
      {
        ...
        choices: [
          ...
          { label: 'B', text: '150 mmHg' },
          { label: 'C', text: '160 mmHg' },
          { label: 'D', text: '713 mmHg' },
        ],
        correctAnswer: 'B',
        ...
        wrongAnswerExplanations: {
          ...
          D: '713 mmHg is the total pressure of dry gases after subtracting water vapor, not just the oxygen fraction.',
        },
      ...
      },
      {
        ...
        wrongAnswerExplanations: {
          ...
          C: 'k/45 has the same inverse relationship problem and is also dimensionally problematic.',
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          ...
          { label: 'B', text: 'Zn(s) is oxidized at the anode' },
          { label: 'C', text: 'Cu²⁺(aq) is oxidized at the anode' },
          { label: 'D', text: 'Zn²⁺(aq) is oxidized at the cathode' },
        ],
        correctAnswer: 'B',
        ...
        wrongAnswerExplanations: {
          ...
          D: 'Zn²⁺ is the product of Zn oxidation; it does not itself undergo oxidation. The cathode is the site of reduction, not oxidation.',
        },
      ...
      },
      {
        ...
        choices: [
          { label: 'A', text: 'Keq ≈ 10³⁷' },
          { label: 'B', text: 'Keq ≈ 10²³' },
          { label: 'C', text: 'Keq ≈ 10³⁷ — confirming the reaction strongly favors products' },
    ...
    questions: [
      {
        ...
        choices: [
          ...
          { label: 'B', text: 'An accommodating eye focused at a near object approximately 10 cm away' },
          { label: 'C', text: 'A hyperopic eye requiring a converging corrective lens' },
        ...
        wrongAnswerExplanations: {
          ...
          C: 'Hyperopia means the eye has insufficient power (P too low); at P = 60 D with a 2 cm axial length, the power is actually above the minimum for emmetropia, not below.',
      ...
      },
      {
        ...
        choices: [
          { label: 'A', text: 'Bend toward the normal because it enters a denser medium' },
          { label: 'B', text: 'Bend away from the normal because it enters a less dense medium' },
        ...
        wrongAnswerExplanations: {
          A: 'Light bends toward the normal only when moving into a denser medium (higher n). Here n decreases from 1.38 to 1.34.',
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          ...
          { label: 'B', text: 'Intracellular [ATP] is far higher than [ADP][Pᵢ], making Q << Keq and driving ΔG more negative' },
          { label: 'C', text: 'Cellular enzymes (ATPases) catalyze ATP hydrolysis faster, making ΔG more negative' },
          { label: 'D', text: 'The intracellular pH of 7.4 is higher than the standard pH 7.0, shifting equilibrium' },
        ],
        correctAnswer: 'B',
        ...
        wrongAnswerExplanations: {
          ...
          D: 'The difference between pH 7.0 and 7.4 has a small effect on ΔG°\' but is not the dominant factor explaining a 25 kJ/mol difference. Concentration ratios dominate.',
        },
      ...
      },
      {
        ...
        choices: [
          ...
          { label: 'B', text: 'Spontaneous only below 500 K' },
          { label: 'C', text: 'Spontaneous only above 500 K' },
          { label: 'D', text: 'Never spontaneous' },
        ],
        correctAnswer: 'B',
        ...
        wrongAnswerExplanations: {
          ...
          D: 'At low temperatures (T → 0), ΔG° ≈ ΔH° = −40 kJ/mol < 0, which is spontaneous.',
        },
