    ...
    questions: [
      {
        ...
        wrongAnswerExplanations: {
          A: '0.154 °C = 0.512 × 0.30 × 1 — uses i = 1, failing to account for NaCl dissociation into 2 particles.',
      ...
      },
      {
        ...
        choices: [
          { label: 'A', text: '7.6 atm' },
          { label: 'B', text: '15.2 atm' },
        ...
        wrongAnswerExplanations: {
          A: '7.6 atm uses i = 1, forgetting that NaCl fully dissociates into 2 particles.',
      ...
      },
      {
        ...
        choices: [
          { label: 'A', text: 'The cell swells because it is in a hypotonic solution' },
          { label: 'B', text: 'The cell shrinks because it is in a hypertonic solution' },
        ...
        wrongAnswerExplanations: {
          A: 'A hypotonic solution has lower osmolarity than the cell interior. 0.30 M NaCl is hypertonic (higher osmolarity than the cell), causing water efflux, not influx.',
      ...
      },
      {
        ...
        wrongAnswerExplanations: {
          A: '0.30 M NaCl provides 0.30 × 2 × 1,000 = 600 mOsm/kg — half the target, equivalent to only twice physiological saline.',
    ...
    questions: [
      {
        ...
        choices: [
          { label: 'A', text: '200 MBq' },
          { label: 'B', text: '100 MBq' },
          { label: 'C', text: '50 MBq' },
          { label: 'D', text: '25 MBq' },
        ],
        correctAnswer: 'B',
        ...
        wrongAnswerExplanations: {
          A: '200 MBq is the initial activity; no decay has been applied.',
      ...
      },
      {
        ...
        choices: [
          { label: 'A', text: 'Z = 52, A = 127' },
          { label: 'B', text: 'Z = 54, A = 131' },
        ...
        wrongAnswerExplanations: {
          A: 'Z = 52, A = 127 describes alpha decay (Z − 2, A − 4), not beta-minus decay.',
      ...
      },
      {
        ...
        choices: [
          ...
          { label: 'B', text: 'Gamma photons penetrate tissue and can be detected externally while depositing minimal energy in tissue' },
          { label: 'C', text: 'Gamma photons increase the atomic number of the isotope, enabling longer imaging windows' },
          { label: 'D', text: 'Gamma photons are absorbed by bone, producing the anatomical contrast needed for imaging' },
        ],
        correctAnswer: 'B',
        ...
        wrongAnswerExplanations: {
          ...
          D: 'Gamma photons are not selectively absorbed by bone in standard nuclear imaging; the contrast comes from differential uptake of the radiopharmaceutical by tissues.',
        },
...
The major products were analyzed by optical rotation.`,
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          { label: 'A', text: '(CH₃)₃CBr (tert-butyl bromide)' },
          { label: 'B', text: 'CH₃CH₂CH₂Br (1-bromopropane)' },
          { label: 'C', text: '(CH₃)₂CHBr (isopropyl bromide)' },
          { label: 'D', text: '(CH₃)₃CCH₂Br (neopentyl bromide)' },
        ],
        correctAnswer: 'B',
        explanation: '1-Bromopropane is a primary alkyl bromide with minimal steric hindrance around the electrophilic carbon. SN2 is disfavored by steric bulk: tertiary > secondary > primary > methyl in steric hindrance. Primary substrates (B) are the most reactive in SN2 because the nucleophile can access the backside of the C–Br bond unobstructed.',
        wrongAnswerExplanations: {
          A: 'tert-Butyl bromide (tertiary) is the most sterically hindered; it undergoes SN1, not SN2. Three methyl groups block backside attack.',
      ...
      },
      {
        ...
        choices: [
          ...
          { label: 'B', text: 'Second order overall; confirms SN2' },
          { label: 'C', text: 'Second order overall; confirms SN1' },
        ...
        wrongAnswerExplanations: {
          ...
          C: 'Second-order kinetics (rate depends on both [substrate] and [nucleophile]) confirms SN2, not SN1.',
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          ...
          { label: 'B', text: 'Pressure decreases because kinetic energy increases at the expense of pressure energy' },
          { label: 'C', text: 'Pressure is unchanged because blood is incompressible' },
          { label: 'D', text: 'Pressure increases because resistance is higher at the narrowing' },
        ],
        correctAnswer: 'B',
        ...
        wrongAnswerExplanations: {
          ...
          D: 'While resistance is higher at the stenosis (Poiseuille\'s Law), Bernoulli\'s equation governs local pressure at a point in steady flow. The Bernoulli effect dominates the local pressure change at the stenosis.',
        },
      ...
      },
      {
        ...
        choices: [
          { label: 'A', text: 'ΔP ≈ 312 Pa' },
          { label: 'B', text: 'ΔP ≈ 3,116 Pa (≈ 23.4 mmHg)' },
        ...
        wrongAnswerExplanations: {
          A: '312 Pa uses ρ = 1,040 kg/m³ and h = 0.03 m — a factor-of-10 error in height (30 cm = 0.30 m, not 0.03 m).',
