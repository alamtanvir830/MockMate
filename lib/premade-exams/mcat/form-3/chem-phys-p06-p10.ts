    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          ...
          { label: 'B', text: 'Because the carbocation intermediate is planar (sp² hybridized), enabling attack from either face with roughly equal probability' },
          { label: 'C', text: 'Because SN1 uses a strong nucleophile that inverts configuration' },
          { label: 'D', text: 'Because the polar protic solvent racemizes the product after the reaction' },
        ],
        correctAnswer: 'B',
        explanation: 'The passage states: "The carbocation is planar (sp² hybridized), enabling nucleophilic attack from either face → racemization (approximately equal mixture of R and S products)." A planar carbocation has no preferred face for attack — the nucleophile has equal probability of attacking from either side, producing equal amounts of R and S enantiomers (racemic mixture). B is correct. A describes retention (same face attack, uncommon). C inverts the logic (strong nucleophiles favor SN2 with inversion). D is incorrect — polar protic solvents facilitate SN1 but do not racemize the product after the fact.',
        wrongAnswerExplanations: {
          ...
          D: 'Polar protic solvents stabilize the carbocation and facilitate its formation (ionization step), but they do not chemically racemize the product. The racemization is inherent to the mechanism (planar carbocation).',
        },
      ...
      },
      {
        ...
        choices: [
          ...
          { label: 'B', text: 'Steric hindrance from the bulky tert-butyl group adjacent to the reaction center blocks backside attack by the nucleophile' },
          { label: 'C', text: 'The leaving group bromide is too poor to support SN2' },
          { label: 'D', text: 'Neopentyl bromide undergoes SN1 instead because it forms a stable tertiary carbocation' },
        ],
        correctAnswer: 'B',
        explanation: 'SN2 requires backside attack at the carbon bearing the leaving group. Although neopentyl bromide is primary (typically SN2-favorable), the carbon adjacent to the reaction center is a quaternary carbon (three methyl groups attached). This creates enormous steric bulk that blocks the trajectory of the incoming nucleophile. The nucleophile cannot approach the reaction center cleanly → very slow SN2. B is correct. A is wrong — primary halides typically DO undergo SN2; neopentyl is an exception due to steric (not electronic) factors. C is wrong — bromide is a good leaving group for both SN1 and SN2. D is wrong — neopentyl bromide cannot readily form a carbocation at the primary carbon; rearrangement would be needed to get a tertiary carbocation, making SN1 also slow.',
        wrongAnswerExplanations: {
          ...
          C: 'Bromide is an excellent leaving group (weak base, stable leaving group). It supports SN2 well. The problem is sterics blocking approach to the carbon, not the leaving group\'s quality.',
      ...
      },
      {
        ...
        difficulty: 'hard',
        question: 'A researcher treats (S)-2-iodopentane with NaOH in DMSO. The major product is (R)-2-pentanol with inverted configuration. If the reaction is repeated with NaOH in ethanol/water, the product is a racemic mixture of 2-pentanol. What different mechanism applies in ethanol/water?',
        choices: [
          { label: 'A', text: 'SN2, because OH⁻ in ethanol/water is still a strong nucleophile' },
          { label: 'B', text: 'E2, because the base (OH⁻) causes elimination rather than substitution in protic solvents' },
          { label: 'C', text: 'SN1, because the polar protic solvent (ethanol/water) stabilizes the carbocation intermediate, enabling ionization and subsequent attack from both faces' },
          { label: 'D', text: 'SN2, because iodide is a better leaving group in polar protic than polar aprotic solvents' },
        ],
        correctAnswer: 'C',
        explanation: 'In DMSO (polar aprotic): strong nucleophile (OH⁻) + secondary substrate → SN2 → inverted product. In ethanol/water (polar protic): the protic solvent stabilizes the carbocation intermediate via H-bonding → favors ionization (SN1). The carbocation (sp², planar) is then attacked from both faces → racemic product. C correctly identifies SN1 as the mechanism in polar protic conditions and explains both the racemization and the role of the protic solvent. A is wrong — while OH⁻ is strong, protic solvents favor SN1 at secondary substrates. B (E2) would give an alkene, not 2-pentanol. D is wrong — iodide leaving group quality doesn\'t differ between solvents in a way that switches mechanisms; the key is carbocation stabilization by the protic solvent.',
        wrongAnswerExplanations: {
          A: 'While OH⁻ is a strong nucleophile, secondary substrates in polar protic solvents tend toward SN1. The racemic product is the evidence — SN2 would give only the inverted product, not a racemic mixture.',
          B: 'E2 elimination with OH⁻ would produce an alkene (2-pentene), not 2-pentanol. The racemic 2-pentanol product rules out elimination.',
          D: 'Iodide is an excellent leaving group in all polar solvents. The mechanism change from inversion to racemization is due to carbocation formation (SN1) in protic solvent, not better leaving group behavior.',
        },
        teachingPoint: 'Experimental evidence for SN1 vs SN2: inverted product = SN2 (one trajectory). Racemic product = SN1 (planar carbocation, equal faces). Temperature kinetics: SN2 rate depends on [Nu], SN1 rate does not. Changing solvent from DMSO (aprotic) to ethanol/water (protic) at a secondary center shifts mechanism from SN2 to SN1.',
        relatedTopics: ['SN1 vs SN2 solvent effect', 'racemization', 'inversion', 'polar protic vs aprotic', 'carbocation solvation'],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        wrongAnswerExplanations: {
          ...
          D: '−0.25 D is the correct sign (diverging) but wrong magnitude. 25 cm = 0.25 m → P = −1/0.25 = −4 D.',
        },
      ...
      },
      {
        ...
        choices: [
          ...
          { label: 'B', text: 'Their near point is farther than 25 cm; they cannot focus on objects within normal near distances without correction' },
          { label: 'C', text: 'Their far point is at 33 cm and they are myopic' },
          { label: 'D', text: 'Their corrective lens provides −3 D to diverge incoming light' },
        ],
        correctAnswer: 'B',
        explanation: 'The passage states hyperopia = "the relaxed eye focuses light behind the retina. The near point is farther than normal — the eye cannot focus close objects." Hyperopia is corrected with converging (positive) lenses (+3 D here). A hyperopic person\'s uncorrected near point is farther than the normal ~25 cm — they cannot see close objects clearly without the converging lens to augment their focusing power. B is correct. A describes a condition requiring diverging lenses (myopia correction). C would describe myopia (far point = 1/P = 1/3 ≈ 33 cm), but the lens here is positive (+3 D), not negative. D has the wrong sign (hyperopia requires converging/positive, not diverging/negative).',
        wrongAnswerExplanations: {
          ...
          D: 'A +3 D lens is converging (convex), not diverging. Hyperopia is corrected with converging lenses to help the eye focus light onto the retina for near objects.',
        },
    ...
    questions: [
      {
        ...
        choices: [
          ...
          { label: 'B', text: '+1.89 eV' },
          { label: 'C', text: '+3.40 eV' },
          { label: 'D', text: '+1.51 eV' },
        ],
        correctAnswer: 'B',
        explanation: 'Eₙ = −13.6/n². E₃ = −13.6/9 = −1.51 eV. E₂ = −13.6/4 = −3.40 eV. ΔE = Efinal − Einitial = E₂ − E₃ = −3.40 − (−1.51) = −1.89 eV. The negative sign indicates energy is released (emission). The photon energy is the magnitude: E_photon = |ΔE| = 1.89 eV. B is correct. This transition is in the Balmer series (to n = 2) and falls in the visible spectrum (red light, ~656 nm). A is wrong — photon energy is the magnitude of ΔE, always positive. C (3.40 eV) = |E₂| alone, not the transition energy. D (1.51 eV) = |E₃| alone.',
        wrongAnswerExplanations: {
          ...
          C: '3.40 eV = |E₂| = energy of the n = 2 level measured from zero. The transition energy is the DIFFERENCE between levels: |E₂ − E₃| = |−3.40 − (−1.51)| = 1.89 eV.',
    ...
    questions: [
      ...
      },
      {
        ...
        wrongAnswerExplanations: {
          ...
          D: 'A single F-18 atom undergoes β⁺ decay. One emitted positron annihilates with one electron → two photons. This is a one-atom, two-photon process, not two atoms each emitting one photon.',
        },
