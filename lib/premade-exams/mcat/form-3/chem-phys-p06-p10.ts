...
Flame spectroscopy identifies elements by their characteristic emission spectra. Each element has a unique set of emission lines because electron energy levels are element-specific.`,
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          { label: 'A', text: 'Balmer series; n = 3 → n = 2 transition' },
          { label: 'B', text: 'Lyman series; n = 2 → n = 1 transition' },
          { label: 'C', text: 'Paschen series; n = 4 → n = 3 transition' },
          { label: 'D', text: 'Lyman series; n = 3 → n = 1 transition' },
        ],
        correctAnswer: 'B',
        explanation: 'E_photon = hc/λ = 1240 eV·nm / 121.6 nm ≈ 10.2 eV. Check n = 2 → n = 1 (Lyman): ΔE = E₁ − E₂ = (−13.6/1) − (−13.6/4) = −13.6 + 3.4 = −10.2 eV. Magnitude = 10.2 eV ✓. This is the Lyman alpha line (121.6 nm), the longest-wavelength (lowest-energy) line in the Lyman series. The passage identifies Lyman series as transitions to n = 1 (UV range). B is correct. A (Balmer, n=3→2) emits 1.89 eV at 656 nm (red, visible). C (Paschen, n=4→3) emits 0.66 eV in IR. D (Lyman, n=3→1) emits 12.09 eV at 102.6 nm.',
        wrongAnswerExplanations: {
          A: 'The n = 3 → 2 Balmer transition emits 1.89 eV at 656 nm (visible red). The photon at 121.6 nm has energy 10.2 eV, far too high for the Balmer series.',
