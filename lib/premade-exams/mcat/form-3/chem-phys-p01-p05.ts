...
Electrolytic cells require an applied external voltage exceeding the cell's decomposition potential to drive a thermodynamically unfavorable reaction. The minimum external voltage required equals the magnitude of the cell potential for the reverse reaction.`,
    ...
    questions: [
      ...
      },
      {
        ...
        correctAnswer: 'B',
        explanation: 'The overall cell reaction is: Zn(s) + Cu²⁺(aq) → Zn²⁺(aq) + Cu(s). Q = [Zn²⁺]/[Cu²⁺] = 0.01/1.0 = 0.01. Q < 1. Nernst: E = E° − (0.0592/2) × log(0.01) = 1.10 − (0.0296) × (−2) = 1.10 + 0.059 ≈ 1.16 V. Since Q < 1, log(Q) < 0, so −log(Q) > 0, meaning E > E°. B is correct. When Q < 1, reactant concentrations are high relative to products → reaction is more favorable → E > E°.',
        wrongAnswerExplanations: {
          A: 'Q = 0.01 < 1, not > 1. When Q > 1, E < E°. Here Q < 1, so E > E°.',
          C: 'Q = 0.01/1.0 = 0.01 ≠ 1. Only when [Zn²⁺] = [Cu²⁺] would Q = 1 and E = E°.',
          D: 'Correct that Q < 1, but the conclusion is wrong. When Q < 1, log(Q) is negative, making the Nernst correction positive, so E > E°, not E < E°.',
        },
      ...
      },
      {
        ...
        choices: [
          ...
          { label: 'B', text: 'Zinc is oxidized at the anode' },
          { label: 'C', text: 'Copper is oxidized at the anode' },
          { label: 'D', text: 'Zinc is reduced at the anode' },
        ],
        correctAnswer: 'B',
        explanation: 'The passage states the zinc anode (E° = −0.76 V) and copper cathode (E° = +0.34 V). The anode is where oxidation occurs (Zn → Zn²⁺ + 2e⁻). The cathode is where reduction occurs (Cu²⁺ + 2e⁻ → Cu). B is correct. A reverses the electrode identities and the half-reaction type. C is partially correct about copper but wrong about the electrode. D has the wrong half-reaction for zinc.',
        wrongAnswerExplanations: {
          A: 'Copper is reduced (Cu²⁺ + 2e⁻ → Cu) at the cathode, not oxidized. The cathode undergoes reduction.',
          C: 'Copper is the cathode material; the cathode is where reduction occurs. Copper metal is the product of reduction of Cu²⁺, not the species oxidized.',
    ...
    questions: [
      {
        ...
        wrongAnswerExplanations: {
          ...
          C: 'At pH 7.4, which is 4.95 units below pKa3 = 12.35, PO₄³⁻ is essentially absent. log([PO₄³⁻]/[HPO₄²⁻]) = 7.4 − 12.35 = −4.95 → PO₄³⁻ is ~10^−5 of HPO₄²⁻.',
      ...
      },
      {
        ...
        choices: [
          ...
          { label: 'B', text: 'Respiratory acidosis; compensation by increasing renal HCO₃⁻ retention and H⁺ excretion' },
          { label: 'C', text: 'Respiratory alkalosis; compensation by increasing ventilation rate' },
          { label: 'D', text: 'Metabolic alkalosis; compensation by renal excretion of HCO₃⁻' },
        ],
        correctAnswer: 'B',
        explanation: 'The passage states: pH 7.25 (acidosis), PaCO₂ = 55 mmHg (elevated, normal 35–45 mmHg), HCO₃⁻ = normal. Elevated CO₂ with normal HCO₃⁻ and acidosis = respiratory acidosis (primary defect is CO₂ retention, not metabolic). Renal compensation: the kidney retains HCO₃⁻ and excretes H⁺ → raises HCO₃⁻ → partially corrects the pH. B is correct. A (metabolic acidosis) would show low HCO₃⁻, not elevated CO₂. C (respiratory alkalosis) would show low CO₂, not elevated, and pH > 7.45. D (metabolic alkalosis) would show high HCO₃⁻ and pH > 7.45.',
        wrongAnswerExplanations: {
          ...
          D: 'Metabolic alkalosis would show high HCO₃⁻ (the primary defect) and pH > 7.45. This patient has normal HCO₃⁻ and acidosis.',
        },
      ...
      },
      {
        ...
        choices: [
          { label: 'A', text: 'Each proton is more strongly hydrogen-bonded to water than the previous' },
          { label: 'B', text: 'Each successive deprotonation requires removing a proton from an increasingly negatively charged ion, requiring more energy' },
      ...
      },
      {
        ...
        wrongAnswerExplanations: {
          ...
          D: 'pKa3 = 12.35 is where [HPO₄²⁻] = [PO₄³⁻] for the third dissociation. Not relevant at physiological pH.',
        },
      ...
      },
      {
        ...
        choices: [
          ...
          { label: 'B', text: 'Renal compensation has elevated plasma HCO₃⁻, restoring the HCO₃⁻/CO₂ ratio and pH toward normal' },
          { label: 'C', text: 'The phosphate buffer has neutralized the excess H⁺ from carbonic acid dissociation' },
          { label: 'D', text: 'Elevated CO₂ directly inhibits carbonic anhydrase, reducing H₂CO₃ formation' },
        ],
        correctAnswer: 'B',
        explanation: 'In chronic respiratory acidosis (emphysema with chronically elevated CO₂), the kidney compensates by retaining HCO₃⁻ (reabsorption) and excreting H⁺. Over days to weeks, plasma HCO₃⁻ rises substantially above normal. The Henderson-Hasselbalch equation for the bicarbonate buffer: pH = 6.1 + log([HCO₃⁻]/0.03×PaCO₂). With elevated CO₂ (denominator increases) and elevated HCO₃⁻ (numerator increases), the ratio can be restored to near normal, and pH returns toward normal. This is fully compensated respiratory acidosis. B is correct. A is wrong — patients with emphysema cannot hyperventilate effectively (their disease prevents it). C (phosphate buffer) is a minor contributor and cannot fully restore pH. D inverts — elevated CO₂ does not inhibit carbonic anhydrase; it actually drives more carbonic acid formation.',
        wrongAnswerExplanations: {
          ...
          D: 'Elevated CO₂ does not inhibit carbonic anhydrase. Carbonic anhydrase catalyzes CO₂ + H₂O ⇌ H₂CO₃ and functions in both directions. Elevated CO₂ drives the equilibrium toward H₂CO₃ and H⁺ formation, worsening (not correcting) the acidosis.',
        },
...
For a point source radiating uniformly in all directions, intensity falls off with the inverse square law: I ∝ 1/r², where r is distance from the source. Doubling the distance reduces intensity by a factor of 4 (reduces SIL by ~6 dB).`,
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          { label: 'A', text: 'Transverse — air molecules oscillate perpendicular to the direction of wave propagation' },
          { label: 'B', text: 'Longitudinal — air molecules oscillate parallel to the direction of wave propagation via compression and rarefaction' },
...
────────────────────────────────────`,
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          { label: 'A', text: 'K increases because activation energy and K are directly related' },
          { label: 'B', text: 'K is unchanged because K depends on ΔG°, not activation energy' },
      ...
      },
      {
        ...
        wrongAnswerExplanations: {
          ...
          C: 'ΔG = 0 at equilibrium where Q = K = 10. Here Q = 100 ≠ K, so the system is not at equilibrium.',
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          ...
          { label: 'B', text: 'Flow rate is halved' },
          { label: 'C', text: 'Flow rate is unchanged because length doesn\'t affect pressure' },
          { label: 'D', text: 'Flow rate decreases 4-fold' },
        ],
        correctAnswer: 'B',
        explanation: 'Poiseuille\'s law: Q = πr⁴ΔP/(8ηL). Flow rate Q is inversely proportional to length L: Q ∝ 1/L. Doubling L: Q_new = Q_old/2. Flow is halved. B is correct. A would require Q ∝ L (direct proportion). C is incorrect — length appears in the denominator and directly affects resistance. D would require Q ∝ 1/L² or Q ∝ 1/r² relationship.',
        wrongAnswerExplanations: {
          ...
          D: 'A 4-fold decrease would require Q ∝ 1/L². The actual relationship is Q ∝ 1/L (inverse, not inverse square). Only r has a fourth-power dependence.',
        },
