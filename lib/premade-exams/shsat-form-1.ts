 ...
 *
 * HOW TO ADD QUESTIONS / REPLACE CONTENT:
 *   - Edit the passages array in any section below.
 *   - Each passage owns its questions. Question numbers are auto-derived.
 *   - correct_answer must be 'A', 'B', 'C', or 'D' — the letter, not the text.
 *
 * HOW TO ADD FORM 2:
 *   1. Create lib/premade-exams/shsat-form-2.ts
 *   2. Copy this file's structure, change the id and content.
 *   3. Import shsatForm2 in app/(dashboard)/premade/shsat/page.tsx
 *   4. Update the Form 2 card to link to /premade/shsat/form-2.
 *   5. Create app/(dashboard)/premade/shsat/form-2/page.tsx (copy form-1/page.tsx).
 */
...
export interface SHSATSection {
  id: string
  number: number  // used in breadcrumb: "SECTION 2"
  title: string
...
export const shsatForm1: SHSATForm = {
  ...
  sections: [
    // ── SECTION 2: ELA Reading Comprehension ─────────────────────────────────
    {
      id: 'section-2-ela',
      number: 2,
          ...
          questions: [
            ...
            },
            {
              ...
              choices: [
                ...
                { id: 'B', text: 'Clay found his relatives\' words dismissive and unhelpful.' },
