...
export const mathQuestionsB3a: QBQuestion[] = [
...

  {
    ...
    questionType: 'multiple_choice',
    stimulus:
      'A pipeline carries water at a flow rate of 4.5 liters per second. A storage tank initially contains 180 liters. Water flows into the tank through the pipeline and simultaneously drains out at a constant rate of 1.2 liters per second.',
    question: 'How many liters will be in the tank after 40 seconds?',
    choices: [
      { label: 'A', text: '192' },
      { label: 'B', text: '204' },
      { label: 'C', text: '312' },
    ...
    correctAnswer: 'C',
    explanation:
      'Net inflow rate = 4.5 − 1.2 = 3.3 liters per second. Volume added in 40 seconds = 3.3 × 40 = 132 liters. Final volume = 180 + 132 = 312 liters.',
    wrongAnswerExplanations: {
      A: 'Using only the drain rate to find change: 1.2 × 40 = 48, then 180 + 48 = 228... or computing net rate as 4.5 − 1.2 = 3.3 but then multiplying by only 4 seconds (a decimal-place error): 3.3 × 4 = 13.2, giving 180 + 13.2 ≈ 193 ≈ 192.',
      B: 'Computing the net rate incorrectly as 4.5 − 4.5 × (1.2/4.5) = 3.3 but then multiplying only the inflow by 40 and subtracting the drain separately: 4.5 × 40 − 1.2 × 40 − 180... arithmetic errors on this path land on 204.',
      D: 'Ignoring the drain and computing only inflow: 4.5 × 40 = 180, then 180 + 180 = 360.',
    },
    teachingPoint:
      'When a quantity flows in and out simultaneously, compute the net rate first: net rate = inflow − outflow = 4.5 − 1.2 = 3.3 L/s. Then multiply by time: 3.3 × 40 = 132 L added. Finally add to the initial amount: 180 + 132 = 312 L. Do not forget the initial amount.',
...

  {
    ...
    questionType: 'multiple_choice',
    stimulus:
      'A grain silo consists of a cylinder topped by a cone. The cylinder has a radius of 4 meters and a height of 9 meters. The cone has the same radius and a height of 3 meters.',
    question: 'What is the total volume of the silo, in cubic meters?',
    choices: [
      { label: 'A', text: '144π + 16π' },
      { label: 'B', text: '144π + 48π' },
      { label: 'C', text: '144π + 64π' },
      { label: 'D', text: '208π' },
    ],
    correctAnswer: 'A',
    explanation:
      'Volume of the cylinder = πr²h = π(4²)(9) = 16π × 9 = 144π m³. Volume of the cone = (1/3)πr²h = (1/3) × π(16)(3) = (1/3)(48π) = 16π m³. Total = 144π + 16π = 160π m³. Choice A correctly expresses the two components: 144π (cylinder) + 16π (cone).',
    wrongAnswerExplanations: {
      B: 'Dropping the (1/3) factor from the cone formula: π(16)(3) = 48π instead of 16π, giving 144π + 48π.',
      C: 'Dropping the (1/3) factor and replacing the cone\'s height (3) with the radius (4): π(16)(4) = 64π.',
      D: 'Computing the cylinder correctly (144π) but using cone height incorrectly as 4 instead of 3 without the 1/3 factor: π(16)(4) = 64π, then adding: 144π + 64π = 208π.',
    },
    teachingPoint:
      'For composite solids, compute each part separately using the correct formula. Cone volume = (1/3)πr²h — the factor of 1/3 is frequently forgotten. Here (1/3)π(16)(3) = 16π; cylinder π(16)(9) = 144π; total = 160π m³.',
