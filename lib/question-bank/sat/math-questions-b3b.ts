...
export const mathQuestionsB3b: QBQuestion[] = [
...

  {
    ...
    questionType: 'multiple_choice',
    question:
      'Two parallel lines p and q are cut by a transversal t. One co-interior (same-side interior) angle is (4x + 11)° and the other co-interior angle on the same side is (6x − 1)°. A third angle formed where the transversal meets line q is the alternate interior angle to the (4x + 11)° angle. What is the measure, in degrees, of that alternate interior angle?',
    choices: [
      { label: 'A', text: '75' },
      { label: 'B', text: '79' },
      { label: 'C', text: '83' },
    ...
    correctAnswer: 'B',
    explanation:
      'Co-interior angles are supplementary: (4x + 11) + (6x − 1) = 180 → 10x + 10 = 180 → 10x = 170 → x = 17. Angle at line p = 4(17) + 11 = 68 + 11 = 79°. Angle at line q (co-interior) = 6(17) − 1 = 102 − 1 = 101°. Verify: 79° + 101° = 180° ✓. The alternate interior angle to the (4x + 11)° angle lies at line q on the opposite side of the transversal — alternate interior angles between parallel lines are congruent — so it equals (4x + 11)° = 79°.',
    wrongAnswerExplanations: {
      A: 'Setting up 4x + 11 = 6x − 1 (treating the angles as equal, as alternate interior angles would be, instead of supplementary): 2x = 12 → x = 6 → 4(6) + 11 = 35°. Various downstream arithmetic errors land near 75°.',
      C: 'An arithmetic error in solving 10x + 10 = 180: computing 10x = 170 correctly but then x = 17.3 (dividing 170 by 10 incorrectly) → 4(17.3) + 11 ≈ 80°; or setting 10x = 180 − 10 = 170 but then solving x = 72/10 and getting 4(18) + 11 = 83°.',
      D: 'Reporting the co-interior angle at line q: 6(17) − 1 = 101°. This is the co-interior companion angle, not the alternate interior angle.',
    },
    teachingPoint:
      'Two steps required: (1) use the co-interior (supplementary) rule to form the equation and solve for x; (2) recall that alternate interior angles are congruent to their counterpart across the transversal — not supplementary. Here x = 17 gives (4x+11) = 79°, and the alternate interior angle at line q also equals 79°.',
