...
export const mathQuestionsB5a: QBQuestion[] = [
...

  {
    ...
    // 6x+5: min = 6(−2)+5=−7; max = 6(2)+5=17. So −7 ≤ 6x+5 ≤ 17. ✓ Answer C.
    id: 'math-b5a-011',
    test: 'SAT',
    section: 'math',
    domain: 'Algebra',
    ...
    choices: [
      ...
      { label: 'B', text: '−3 ≤ 6x + 5 ≤ 13' },
      { label: 'C', text: '−7 ≤ 6x + 5 ≤ 17' },
...

  {
    ...
    correctAnswer: 'D',
    explanation: `The slope through (1, 3) and (4, 9) is (9 − 3)/(4 − 1) = 6/3 = 2. The original line is y = 2x + 1. Answer A has the same slope and the same y-intercept (it is the same line). Answer B has slope 2 and y-intercept −1, which is different — it is parallel. Answers C and D have different slopes.`,
