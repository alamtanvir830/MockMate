...
The moral realist responds by arguing that convergence of moral views across independent cultures and historical periods is evidence — defeasible, fallible evidence — that those converging views are tracking something real. The near-universal condemnation of gratuitous cruelty, for instance, does not look like a parochial preference; it looks like the recognition of a moral fact. Yet this response faces its own difficulty: how do we distinguish genuine moral convergence from convergence driven by shared power structures, economic conditions, or evolutionary pressures that have nothing to do with moral truth?`,
    ...
    wrongAnswerExplanations: {
      ...
      B: 'The author does not conclude that moral realism is preferable — the passage ends with a question mark, suggesting both positions face challenges. The finding would strengthen a realist argument within the debate described, but the author\'s overall stance remains uncommitted.',
...
The persistence of the attribution premium — the dramatic increase in market and critical esteem that follows successful attribution to a canonical master — suggests that art audiences do not actually behave as formalists. They care about who made a thing, not just what it looks like. This may reflect a deep and not easily dismissible intuition that authenticity — the genuine causal connection between a canonized artist and the object in front of us — has aesthetic significance that cannot be captured in purely formal terms.`,
    ...
    choices: [
      { label: 'A', text: 'Formalism, because aesthetic value resides in formal properties, which are the same regardless of origin' },
      { label: 'B', text: 'Intentionalism, because the computer generates structures that approximate human intentions' },
    ...
    wrongAnswerExplanations: {
      ...
      B: 'Intentionalism requires intentions from an intentional agent (a human mind with goals and purposes). A computer generating music does not have intentions in the relevant sense, so intentionalism would likely not support equal valuation — it would either require human-like intention or would deny the computer\'s output the same aesthetic status.',
    },
...
The persistence of the attribution premium — the dramatic increase in market and critical esteem that follows successful attribution to a canonical master — suggests that art audiences do not actually behave as formalists. They care about who made a thing, not just what it looks like. This may reflect a deep and not easily dismissible intuition that authenticity — the genuine causal connection between a canonized artist and the object in front of us — has aesthetic significance that cannot be captured in purely formal terms.`,
    ...
    choices: [
      ...
      { label: 'B', text: 'committed: the author explicitly endorses the authenticity view over formalism and intentionalism' },
      { label: 'C', text: 'dismissive: attributing aesthetic value to provenance confuses economic and aesthetic categories' },
      { label: 'D', text: 'sympathetic: the intuition that authenticity has aesthetic significance may be genuine and not easily dismissed' },
    ],
    correctAnswer: 'D',
    explanation: 'Choice D is correct. The final sentence says the persistence of the attribution premium "may reflect a deep and not easily dismissible intuition that authenticity...has aesthetic significance that cannot be captured in purely formal terms." The phrase "not easily dismissible" indicates the author takes this intuition seriously, and the phrase "may reflect" indicates careful, non-dogmatic consideration. This is a sympathetic but uncommitted stance toward the authenticity view.',
    wrongAnswerExplanations: {
      ...
      B: 'The author uses hedged language throughout: "may reflect," "not easily dismissible," "suggests." This indicates careful agnosticism, not explicit endorsement. The author never says the authenticity view is correct, only that the intuition behind it deserves consideration.',
...
Critics of the alienation thesis have argued that this portrait is unduly nostalgic and that craft labor was itself often brutal, exhausting, and socially constrained — that the "freedom" of the artisan was frequently overstated by comparison to the genuine miseries of peasant agriculture. Moreover, they point out that industrial workers rapidly developed new forms of solidarity, identity, and culture — trade unions, working-class neighborhoods, popular amusements — that were not merely pale substitutes for pre-industrial community but genuinely new social formations suited to the new conditions.`,
    ...
    choices: [
      { label: 'A', text: 'explain Thompson\'s concept of the shift from task-orientation to time-discipline and its implications for workers\' self-conception' },
      { label: 'B', text: 'provide a counterargument to Thompson\'s thesis about time-discipline' },
    ...
    wrongAnswerExplanations: {
      ...
      B: 'The counterargument appears in the fourth paragraph (critics who argue the artisan\'s freedom was overstated). The second paragraph only presents Thompson\'s thesis without any rebuttal.',
    },
...
Defenders of scientific rationality were quick to object. Karl Popper had argued that the mark of scientific theories is their falsifiability — the possibility of their being proven wrong by evidence. For Popper, science advances through the bold conjecture of theories and their rigorous testing; when a theory is falsified, it is rejected, and the process of conjecture and refutation continues. On this view, the growth of knowledge is rational even if not cumulative in the simple additive sense — it advances through the active elimination of falsehoods. Critics of Kuhn argue that his incommensurability thesis, pushed to an extreme, dissolves the distinction between scientific revolutions and mere changes in cultural fashion, and that scientists do in fact share sufficient rational standards to evaluate competing theories across paradigm shifts.`,
    ...
    choices: [
      { label: 'A', text: 'Scientific growth involves the replacement of theories, not merely their supplementation, and is therefore not simply additive' },
      { label: 'B', text: 'Scientific progress is straightforwardly cumulative, with each generation building on the last' },
    ...
    wrongAnswerExplanations: {
      ...
      B: 'The passage explicitly presents Kuhn as disrupting the classical cumulative image and Popper as saying growth is "not cumulative in the simple additive sense." Neither endorses simple cumulative progress.',
    },
...
A third group argues that even if the non-identity problem creates difficulties for harm-based frameworks, it does not dissolve all obligations. Rights-based theorists hold that future persons — whatever the causal history of their existence — will possess human dignity and entitlements that bind present-day actors. These rights arise not from a comparison between actual and counterfactual lives but from what it means to be a human person.`,
    ...
    choices: [
      { label: 'A', text: 'Introduce the philosophical puzzle that challenges person-affecting frameworks for thinking about obligations to future people' },
      { label: 'B', text: 'Present the author\'s preferred resolution to the problem of obligations to future generations' },
    ...
    correctAnswer: 'A',
    explanation: 'Choice A is correct. The third paragraph introduces Parfit\'s non-identity problem — the conceptual difficulty that the specific future people harmed by Policy B would not have existed under Policy B, making it hard to say they were harmed. This establishes the central philosophical puzzle that the rest of the passage responds to. It is not the author\'s preferred resolution (the author presents no preferred view) and contains no empirical data.',
    wrongAnswerExplanations: {
      ...
      B: 'The passage presents no resolution — neither in the third paragraph nor anywhere else. The third paragraph introduces the problem; the fourth and fifth paragraphs present responses. The author does not endorse any of them.',
    },
...
A third position refuses both the complete freedom of the universalist and the strict policing of cultural property. It argues that the meaningful distinction is not between insiders and outsiders but between kinds of attention. A work that treats another culture's practices as exotic spectacle for an uninformed audience — deploying sacred symbols as ornament, reducing a people's history to colorful backdrop — is aesthetically and ethically thin regardless of the author's cultural origin. A work that engages a culture with close, sustained, historically informed attention, treating its people as fully human rather than as picturesque objects, can achieve genuine seriousness and moral integrity whatever the author's background.`,
    ...
    choices: [
      ...
      { label: 'B', text: 'Alarmist — the author suggests cross-cultural borrowing will cause irreparable harm to minority artistic traditions' },
      ...
      { label: 'D', text: 'Even-handed but leading — the author presents all three views fairly, with the passage structure implicitly favoring the third view as a nuanced synthesis' },
    ],
    correctAnswer: 'D',
    explanation: 'Choice D is correct. The author presents all three views in order — critics, defenders, third position — giving each genuine space and strongest-case treatment. Yet the passage devotes its final paragraph to the third view and describes it with the most positive language ("genuine seriousness," "moral integrity"), implying it as a resolution of the preceding debate. This structure — balanced presentation that nonetheless concludes with one view described most favorably — is "even-handed but leading."',
    wrongAnswerExplanations: {
      ...
      B: 'The passage does not predict or warn of irreparable harm to artistic traditions. It presents a conceptual debate about authenticity and attention, not a social alarm about cultural survival.',
...
A third position refuses both the complete freedom of the universalist and the strict policing of cultural property. It argues that the meaningful distinction is not between insiders and outsiders but between kinds of attention. A work that treats another culture's practices as exotic spectacle for an uninformed audience — deploying sacred symbols as ornament, reducing a people's history to colorful backdrop — is aesthetically and ethically thin regardless of the author's cultural origin. A work that engages a culture with close, sustained, historically informed attention, treating its people as fully human rather than as picturesque objects, can achieve genuine seriousness and moral integrity whatever the author's background.`,
    ...
    choices: [
      { label: 'A', text: 'Cultural origin or lineage — the tradition from which a work or its creator derives' },
      { label: 'B', text: 'Technical artistic skill or mastery of craft' },
    ...
    wrongAnswerExplanations: {
      ...
      B: 'The paragraph makes no mention of technical skill or craft. The critic\'s criterion is about where the artist comes from, not how technically accomplished they are. A skilled outsider is still an outsider by this standard.',
    },
...
A more defensible position holds that cultural literacy and inquiry-based learning are complementary phases rather than alternative paradigms. Early education, on this view, should emphasize the acquisition of a broad shared repertoire — not as dogma, but as the grammar of future inquiry. Advanced instruction should then leverage that foundation to cultivate the habits of critical interrogation Dewey rightly prized. The failure of both Hirsch and Dewey lies not in their diagnoses but in their prescriptions: each correctly identifies what the other ignores while insisting, unnecessarily, that the virtues of their own position require the rejection of their opponent's.`,
    ...
    choices: [
      ...
      { label: 'B', text: 'Polemical and partisan, using rhetorical exaggeration to argue for a return to content-centered education' },
    ...
    wrongAnswerExplanations: {
      ...
      B: 'Polemical connotes one-sided rhetorical advocacy. The author\'s stance is synthetic and concedes valid points to both sides. The passage argues neither for content-only nor process-only education but for a complementary phased approach.',
...
A more defensible position holds that cultural literacy and inquiry-based learning are complementary phases rather than alternative paradigms. Early education, on this view, should emphasize the acquisition of a broad shared repertoire — not as dogma, but as the grammar of future inquiry. Advanced instruction should then leverage that foundation to cultivate the habits of critical interrogation Dewey rightly prized. The failure of both Hirsch and Dewey lies not in their diagnoses but in their prescriptions: each correctly identifies what the other ignores while insisting, unnecessarily, that the virtues of their own position require the rejection of their opponent's.`,
    ...
    choices: [
      ...
      { label: 'B', text: 'Criticism, because the inquiry phase begins too late at grade 7 — students should encounter problem-based learning from the earliest years per Dewey\'s vision' },
    ...
    wrongAnswerExplanations: {
      ...
      B: 'The author does not advocate for Dewey\'s full model in early education — paragraph 4 explicitly recommends content emphasis in early education. Starting inquiry earlier would actually contradict the author\'s view that content comes first as "the grammar of future inquiry."',
...
A more defensible position holds that cultural literacy and inquiry-based learning are complementary phases rather than alternative paradigms. Early education, on this view, should emphasize the acquisition of a broad shared repertoire — not as dogma, but as the grammar of future inquiry. Advanced instruction should then leverage that foundation to cultivate the habits of critical interrogation Dewey rightly prized. The failure of both Hirsch and Dewey lies not in their diagnoses but in their prescriptions: each correctly identifies what the other ignores while insisting, unnecessarily, that the virtues of their own position require the rejection of their opponent's.`,
    ...
    choices: [
      { label: 'A', text: 'A longitudinal study finding that students who first receive broad content instruction and subsequently shift to inquiry-based learning develop stronger critical-thinking and application skills than students who receive either type of instruction exclusively' },
      { label: 'B', text: 'A study finding that students taught exclusively with Hirsch\'s curriculum score higher on standardized content-knowledge tests than students taught exclusively with Dewey\'s methods' },
    ...
    wrongAnswerExplanations: {
      ...
      B: 'This finding would support Hirsch\'s model over Dewey\'s on one specific metric (content-knowledge tests), but it does not support the claim that the two are complementary. If anything, it supports the superiority of one approach over the other — the opposite of a complementarity argument.',
    },
...
The most defensible position locates meaning in the interaction between text, author-context, and reader, with authorial intention functioning as one constraint among several — supplemented by generic conventions, historical context, intertextual relations, and the coherence demands of the text itself. On this account, interpretation is neither an act of archaeological recovery (the critic excavates the author's buried intention) nor unconstrained creation (the reader invents the text anew) but a disciplined negotiation of multiple stabilizing factors.`,
    ...
    choices: [
      ...
      { label: 'B', text: 'The approach is valid if the diary corroborates evidence already present in the text, but invalid if it introduces meaning not textually supported' },
...
The most defensible position locates meaning in the interaction between text, author-context, and reader, with authorial intention functioning as one constraint among several — supplemented by generic conventions, historical context, intertextual relations, and the coherence demands of the text itself. On this account, interpretation is neither an act of archaeological recovery (the critic excavates the author's buried intention) nor unconstrained creation (the reader invents the text anew) but a disciplined negotiation of multiple stabilizing factors.`,
    ...
    choices: [
      ...
      { label: 'B', text: 'Provide empirical evidence that readers who ignore authorial intention make more interpretive errors on standardized literary assessments' },
      ...
      { label: 'D', text: 'Identify the theoretical problem that Barthes\'s position must solve — namely, how to distinguish legitimate from arbitrary interpretations — thereby motivating the need for interpretive constraints articulated in paragraph 4' },
    ],
    correctAnswer: 'D',
    explanation: 'Choice D is correct. The third paragraph poses a challenge to Barthes\'s view: if the author\'s intent is irrelevant, what prevents arbitrary readings? The paragraph uses the Kafka and Swift examples not to show that reader-response always fails, but to establish that some readings are clearly wrong, which means constraints must exist somewhere. This creates the logical need for the answer given in paragraph 4: multiple constraints (genre, context, text coherence) that stabilize interpretation without resorting to authorial intent as the sole anchor.',
    wrongAnswerExplanations: {
      ...
      B: 'There is no empirical evidence or research cited anywhere in the passage. The mode of argument is philosophical and conceptual throughout.',
...
The most defensible position locates meaning in the interaction between text, author-context, and reader, with authorial intention functioning as one constraint among several — supplemented by generic conventions, historical context, intertextual relations, and the coherence demands of the text itself. On this account, interpretation is neither an act of archaeological recovery (the critic excavates the author's buried intention) nor unconstrained creation (the reader invents the text anew) but a disciplined negotiation of multiple stabilizing factors.`,
    ...
    choices: [
      { label: 'A', text: 'Fixed and bounded — setting a definite limit on the range of valid interpretations' },
      { label: 'B', text: 'Authoritative and influential in shaping critical opinion' },
    ...
    wrongAnswerExplanations: {
      ...
      B: '"Authoritative and influential in shaping critical opinion" captures something about authority but misses the key function in the sentence: setting a limit on valid meanings. Hirsch\'s point is that authorial intent CONSTRAINS (bounds) interpretation, not merely that it is influential.',
    },
...
A careful reading of both thinkers suggests they are answering different questions. Popper describes what science ought ideally to do — a normative methodology. Kuhn describes what science actually does — a descriptive sociology of knowledge. On this reading, the conflict largely dissolves: we may simultaneously embrace Popperian falsification as the regulative ideal scientists should aspire to, and Kuhnian normal science as a realistic portrait of how paradigm-embedded communities actually operate. The tension is not a contradiction but a productive dialectic between the real and the ideal.`,
    ...
    choices: [
      { label: 'A', text: 'Kuhn\'s account; within normal science, scientists typically accommodate or explain away anomalies rather than treating them as falsifications, defending the paradigm until the anomalies reach a critical mass' },
      { label: 'B', text: 'Popper\'s account; the scientist is attempting to falsify the anomalous data rather than the theory, which is the proper Popperian method' },
...
A careful reading of both thinkers suggests they are answering different questions. Popper describes what science ought ideally to do — a normative methodology. Kuhn describes what science actually does — a descriptive sociology of knowledge. On this reading, the conflict largely dissolves: we may simultaneously embrace Popperian falsification as the regulative ideal scientists should aspire to, and Kuhnian normal science as a realistic portrait of how paradigm-embedded communities actually operate. The tension is not a contradiction but a productive dialectic between the real and the ideal.`,
    ...
    choices: [
      { label: 'A', text: 'Articulate the genuine tension between the two accounts — specifically, the worry that Kuhn\'s descriptive accuracy undermines scientific rationalism — and identify the limitation of each thinker, motivating the synthesis in paragraph 4' },
      { label: 'B', text: 'Present empirical evidence that definitively resolves the debate between Popper and Kuhn in favor of Kuhn\'s historical account' },
    ...
    correctAnswer: 'A',
    explanation: 'Choice A is correct. The third paragraph does two things: (1) states the tension — Kuhn is "historically accurate" but threatens scientific rationalism; Popper is normatively appealing but "struggles to explain" actual anomaly tolerance; and (2) does NOT resolve it, leaving open the question that paragraph 4 will answer. By articulating the limitations of both positions, paragraph 3 creates the logical need for the synthesis in paragraph 4. This is the classic setup-paragraph function.',
    wrongAnswerExplanations: {
      ...
      B: 'Paragraph 3 presents no empirical evidence. Its mode is philosophical criticism — stating that Kuhn\'s account risks relativism and Popper\'s struggles with historical anomalies. No resolution is reached; the paragraph ends with the tension unresolved.',
    },
...
A careful reading of both thinkers suggests they are answering different questions. Popper describes what science ought ideally to do — a normative methodology. Kuhn describes what science actually does — a descriptive sociology of knowledge. On this reading, the conflict largely dissolves: we may simultaneously embrace Popperian falsification as the regulative ideal scientists should aspire to, and Kuhnian normal science as a realistic portrait of how paradigm-embedded communities actually operate. The tension is not a contradiction but a productive dialectic between the real and the ideal.`,
    ...
    choices: [
      ...
      { label: 'B', text: 'The criticism succeeds in undermining the resolution, but a different synthesis is possible if Kuhn\'s descriptive account is treated as normative' },
...
Rather than treat the inconsistency as an embarrassment requiring elimination, however, the author suggests an alternative: the deontological intuition against direct harm may encode real moral wisdom about the dangers of unconstrained consequentialist reasoning. A system that permits — or even requires — treating individuals as mere means to aggregate ends could, if applied consistently, justify atrocities. The visceral resistance to pushing the large man may reflect not a cognitive glitch but an evolved moral constraint that operates as a safeguard against the pathologies of utilitarian extremism.`,
    ...
    choices: [
      ...
      { label: 'B', text: 'The dual-process explanation for moral inconsistency is empirically wrong, and the real explanation is that the footbridge case involves a principled deontological distinction' },
...
Rather than treat the inconsistency as an embarrassment requiring elimination, however, the author suggests an alternative: the deontological intuition against direct harm may encode real moral wisdom about the dangers of unconstrained consequentialist reasoning. A system that permits — or even requires — treating individuals as mere means to aggregate ends could, if applied consistently, justify atrocities. The visceral resistance to pushing the large man may reflect not a cognitive glitch but an evolved moral constraint that operates as a safeguard against the pathologies of utilitarian extremism.`,
    ...
    choices: [
      ...
      { label: 'B', text: 'Provide empirical evidence from psychological experiments that moral intuitions are generally unreliable' },
    ...
    wrongAnswerExplanations: {
      ...
      B: 'The second paragraph does not cite psychological experiments or make claims about general reliability of moral intuitions. It presents a single thought experiment to establish a specific inconsistency, not to make a broad empirical generalization.',
...
The author submits, however, that accuracy-optimization framing is itself the more fundamental problem. Maximizing aggregate predictive accuracy treats error as interchangeable across subjects. But if errors are systematically concentrated among already-disadvantaged groups — if the algorithm is more likely to misclassify Black loan applicants or low-income parolees — then aggregate accuracy gains may come at the cost of distributional justice. What is required is not just more accurate algorithms but frameworks that integrate distributive fairness, procedural transparency, and individual contestability as design constraints, not afterthoughts.`,
    ...
    choices: [
      ...
      { label: 'B', text: 'The system represents an improvement over human decision-making because it at least applies consistent parameters to all applicants, eliminating the mood effects and in-group favoritism described in paragraph 1' },
      ...
      { label: 'D', text: 'The system is ethically inadequate despite its accuracy because its errors are systematically concentrated among disadvantaged applicants (low-income rural populations), violating the distributional fairness standard the author advocates in paragraph 4' },
    ],
    correctAnswer: 'D',
    explanation: 'Choice D is correct. The author\'s framework (paragraph 4) specifically argues that aggregate accuracy is insufficient when errors are "systematically concentrated among already-disadvantaged groups." The disability benefits scenario exactly illustrates this concern: 92% aggregate accuracy, but errors concentrated in low-income rural applicants — a disadvantaged group. The author would evaluate this system as ethically inadequate on distributional justice grounds, regardless of its accuracy advantage over human caseworkers.',
    wrongAnswerExplanations: {
      ...
      B: 'The author does not accept consistency as a morally sufficient defense of algorithmic systems. Paragraph 1 presents this as the proponents\' argument; the author\'s counterargument in paragraph 4 shows that consistent application of biased criteria does not produce just outcomes.',
...
The resolution of this dilemma ultimately depends on prior judgments about epistemic agency that democratic theory has not yet fully worked out. What is clear is that the naive deficit model — the idea that ignorance is the primary obstacle to public understanding of science — cannot be the endpoint of this inquiry.`,
    ...
    choices: [
      ...
      { label: 'B', text: 'Predisposed toward agreement with the scientific community through information exposure and educational intervention' },
      { label: 'C', text: 'Equipped with sufficient technical knowledge to independently verify expert scientific claims' },
      { label: 'D', text: 'Having well-adjusted epistemic judgments — neither dismissing expertise altogether nor treating scientific findings as beyond revision — based on an accurate sense of what is settled versus uncertain in science' },
    ],
    correctAnswer: 'D',
    explanation: 'Choice D is correct. Paragraph 3 explicitly defines calibration: "helping citizens develop accurate estimates of what scientists do and do not know, including the normal presence of uncertainty, controversy, and revision within science itself." The passage further specifies that calibrated citizens "would neither dismiss scientific expertise altogether nor treat scientific findings as equivalent to mathematical certainties immune from further revision." This maps directly to choice D.',
    wrongAnswerExplanations: {
      ...
      B: 'This describes the deficit model goal (citizens converge toward expert views through information exposure), which the author criticizes in paragraph 2. Calibration is the ALTERNATIVE to the deficit model.',
...
Moral progress on the consistency account is nevertheless real, not merely apparent. But it is also neither linear nor guaranteed. Historical regression is documented — periods in which rights previously recognized are withdrawn, protections eliminated, and exclusions reinstated. The consistency account therefore offers no grounds for complacency. That moral progress has occurred in some domains over some periods is compatible with moral regression in others, and with the ever-present possibility of catastrophic reversal.`,
    ...
    choices: [
      ...
      { label: 'B', text: 'Indifference — the author treats optimism and pessimism as equally valid responses to the historical moral record and declines to evaluate either' },
      ...
      { label: 'D', text: 'Qualified skepticism — the author affirms that moral progress is real and has occurred, but argues that its non-linearity and the possibility of regression make optimism a potential source of dangerous complacency' },
    ],
    correctAnswer: 'D',
    explanation: 'Choice D is correct. The author explicitly affirms moral progress is real ("Moral progress on the consistency account is nevertheless real, not merely apparent" — paragraph 5). But immediately qualifies this: progress is "neither linear nor guaranteed," historical regression is documented, and "the consistency account therefore offers no grounds for complacency." The author\'s attitude is affirmation tempered by a warning against complacency rooted in documented regression and catastrophic reversal possibilities.',
    wrongAnswerExplanations: {
      ...
      B: 'The author takes a clear position: real progress exists under the consistency account, but optimism must be tempered by awareness of non-linearity and regression. This is an evaluative stance, not neutrality.',
...
Contemporary philosophy of history has explored the tension between these commitments. Paul Ricoeur argued that historical narrative performs a mimetic function — it represents the temporal structure of human experience — that cannot be reduced either to bare documentary accumulation or to literary invention unconstrained by evidence. Both the scientific and the narrative dimensions of history are essential, and neither can be subordinated to the other without distortion. For Ricoeur, the distinctive character of historical knowledge lies precisely in this productive tension.`,
    ...
    choices: [
      { label: 'A', text: 'Historical knowledge requires both disciplined engagement with documentary evidence and the self-conscious deployment of the historian\'s interpretive perspective' },
      { label: 'B', text: 'Positivist historiography correctly identified the historian\'s task as eliminating subjective bias from the examination of historical evidence' },
    ...
    wrongAnswerExplanations: {
      ...
      B: 'The passage explicitly challenges positivism through two separate critiques (epistemological and ontological). The author does not endorse positivism\'s goal of eliminating bias as correctly identified; rather, the passage treats positivism as an inadequate starting point.',
    },
...
One influential response to the hard problem is the knowledge argument, introduced by Frank Jackson. Jackson asks us to imagine Mary, a scientist who has lived her entire life in a black-and-white room but who knows every physical fact about color perception — the wavelengths, the neural pathways, the functional organization underlying color vision. When Mary leaves the room and sees red for the first time, does she learn something new? Jackson argues she does — she learns what it is like to see red — and takes this as evidence that physicalism is false: not all facts about conscious experience are physical facts. Critics respond that Mary acquires a new ability (to recognize, imagine, and remember red) rather than new propositional knowledge about an irreducible non-physical fact, thereby challenging the conclusion that any fact was missing from her complete physical description.`,
    ...
    choices: [
      ...
      { label: 'B', text: 'The philosophical problem of determining whether any organism other than oneself genuinely possesses conscious states' },
    ...
    wrongAnswerExplanations: {
      ...
      B: 'The "problem of other minds" — determining whether other beings are conscious — is a related but distinct philosophical problem. The hard problem, as described, concerns why subjective experience exists AT ALL, including in one\'s own case, not primarily the attribution of consciousness to others.',
