    ...
    <div className="max-w-3xl mx-auto py-10 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          ...
          <h2 className="text-lg font-semibold text-slate-900 mb-1 group-hover:text-brand-700 transition-colors">SAT</h2>
        ...
        >
          ...
          <h2 className="text-lg font-semibold text-slate-900 mb-1 group-hover:text-brand-700 transition-colors">
            SHSAT
          </h2>
        ...
        >
          ...
          <h2 className="text-lg font-semibold text-slate-900 mb-1 group-hover:text-brand-700 transition-colors">MCAT</h2>
