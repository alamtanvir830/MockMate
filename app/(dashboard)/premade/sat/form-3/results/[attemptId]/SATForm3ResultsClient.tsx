...
export default function SATForm3ResultsClient({ attemptId, satUpgradeUnlocked }: Props) {
  ...
  return <SATExamTaker form={satForm3} initialAttempt={attempt} satUpgradeUnlocked={satUpgradeUnlocked} />
}
