...
export default async function SATForm4ResultsPage({
  ...
  // Non-premium: check if they own a completed Form 4 attempt for this attemptId.
  ...
  if (completedAttempt) {
    ...
    // Free users who completed Form 4 may be eligible for the trial.
  ...
  return (
    <UpgradeGate
      ...
      description="Subscribe to SAT Premium to access your SAT Form 4 results, detailed score breakdowns, and AI feedback."
    />
  )
}
