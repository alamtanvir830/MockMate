  ...
  if (!satUpgradeUnlocked) {
    return (
      <UpgradeGate
        ...
        description="Unlock Form 2, Form 3, Form 4, and 300+ Question Bank practice questions for a one-time payment."
        features={[
          ...
          { label: 'SAT Practice Test Form 4', subtext: 'Score feedback + personalized weak-area question sets from Q-Bank' },
