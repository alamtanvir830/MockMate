...
export default function SATExamTakerClient({ freeWindowExpiresAt, showCountdown, formNumber = 10 }: Props) {
  return (
    <div>
      ...
      <SATExamTaker form={getSatForm(10, getLatestSatContentVersion(10))} contentVersion={getLatestSatContentVersion(10)} skipPasswordGate />
    </div>
  )
}
