...
import { mcatForm2 } from '@/lib/premade-exams/mcat/form-2/form-2'
...
export default function MCATForm2ResultsPage() {
  ...
  return <MCATExamTaker form={mcatForm2} initialAttempt={attempt} />
}
