...
import { mcatForm4 } from '@/lib/premade-exams/mcat/form-4/form-4'
...
export default function MCATForm4ResultsPage() {
  ...
  return <MCATExamTaker form={mcatForm4} initialAttempt={attempt} />
}
