...
import { deleteQBResult } from '@/lib/question-bank/sat/question-selector'
...
export default function QBHistoryPage() {
  ...
  function handleDelete(entry: QBHistoryEntry) {
    if (entry.test === 'MCAT') {
      deleteMCATQBResult(entry.id)
    } else {
      deleteQBResult(entry.id)
    }
