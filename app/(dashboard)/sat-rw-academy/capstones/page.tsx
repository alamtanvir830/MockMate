...
// Capstone metadata — loaded statically; full question data is in /capstones/[id]/page.tsx
const CAPSTONE_META = [
  {
    id: 'capstone-1',
    ...
    module1Label: 'Module 1 · 27 questions',
    module2Label: 'Module 2 · 27 questions',
  ...
  },
  {
    ...
    description: 'A third full-length assessment for maximum mixed practice before the Final Mastery Check.',
    module1Label: 'Module 1 · 27 questions',
    module2Label: 'Module 2 · 27 questions',
...
export default function CapstonesPage() {
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-3xl space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-slate-900">R&W Academy Capstones</h1>
        <p className="mt-1 text-sm text-slate-500">
          Three full-length 54-question R&W assessments. All four domains. All eleven skills.
          Timed. No skill labels during testing.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800 space-y-1">
        ...
        <p className="text-[13px]">
          ...
          Use them to measure your Academy mastery across all skills.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5 space-y-3">
        ...
        <div className="grid gap-3 sm:grid-cols-3 text-center">
          {[
            ...
            { label: 'All 11 skills', sub: '4 domains mixed' },
            { label: 'Timed', sub: '32 min per module' },
          ].map(({ label, sub }) => (
        ...
        {CAPSTONE_META.map((c, i) => (
          <div key={c.id} className="rounded-xl border border-slate-200 bg-white p-5">
            <div className="flex items-start justify-between gap-3 flex-wrap">
              ...
              <Link
                href={`/sat-rw-academy/capstones/${c.id}`}
                className="shrink-0 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold px-4 py-2 transition-colors"
              >
                Start Capstone →
              </Link>
            </div>
      ...
      <div className="rounded-xl border border-sky-200 bg-sky-50 p-4 text-sm text-sky-800">
        ...
        <p className="text-[13px]">
          Complete Capstone 1 after finishing Writing Skills and at least two Reading skill lessons.
          Use the skill breakdown to identify gaps, study those lessons, then take Capstone 2.
          Reserve Capstone 3 for your final full-length review before the real exam.
        </p>
      </div>
    </div>
  )
