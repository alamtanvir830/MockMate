      ...
      {!hasAny && (
        <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-5 flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold text-emerald-900">New here? Start with the Diagnostic</p>
            <p className="text-xs text-emerald-700 mt-0.5">24 questions across all 10 skills — see exactly where to focus first.</p>
          </div>
          <Link
            href="/sat-rw-academy/diagnostic"
            className="shrink-0 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold px-4 py-2 transition-colors whitespace-nowrap"
          >
            Take Diagnostic →
          </Link>
        </div>
